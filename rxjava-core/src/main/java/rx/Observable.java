...
public class Observable<T> {
     ...
     * @since 0.19
     */
    public final static <T> Observable<T> from(Func0<? extends Enumeration<T>> enumerable) {
     ...
     * @since 0.19
     */
    public final static <T> Observable<T> from(Func0<? extends Enumeration<T>> enumerable, Scheduler scheduler) {
