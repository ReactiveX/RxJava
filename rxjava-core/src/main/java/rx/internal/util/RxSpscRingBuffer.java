...
public class RxSpscRingBuffer implements Subscription, RxRingBuffer {

    private static final ObjectPool<RxSpscRingBuffer> POOL = new ObjectPool<RxSpscRingBuffer>() {
    ...
    // despite performance hit this is using Spsc instead of Spsc to allow thread-stealing algorithms, such as in the merge operator where consumption can come from any thread
