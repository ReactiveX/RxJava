...
public final class OperationBuffer {
     ...
     *            the {@link Func1} object representing the specified buffer operation.
     */
    public static <T> OnSubscribeFunc<List<T>> buffer(Observable<? extends T> source, int count) {
     ...
     *            the {@link Func1} object representing the specified buffer operation.
     */
    public static <T> OnSubscribeFunc<List<T>> buffer(Observable<? extends T> source, long timespan, TimeUnit unit) {
     ...
     *            the {@link Func1} object representing the specified buffer operation.
     */
    public static <T> OnSubscribeFunc<List<T>> buffer(Observable<? extends T> source, long timespan, TimeUnit unit, int count) {
     ...
     *            the {@link Func1} object representing the specified buffer operation.
     */
    public static <T> OnSubscribeFunc<List<T>> buffer(Observable<? extends T> source, long timespan, long timeshift, TimeUnit unit) {
    ...
    private static class BufferObserver<T> implements Observer<T> {
        ...
        public BufferObserver(Buffers<T> buffers, Observer<? super List<T>> observer, BufferCreator<T> creator) {
    ...
    private static class NonOverlappingBuffers<T> extends Buffers<T> {
        ...
        public NonOverlappingBuffers(Observer<? super List<T>> observer) {
            super(observer);
        }
    ...
    private static class OverlappingBuffers<T> extends Buffers<T> {
        public OverlappingBuffers(Observer<? super List<T>> observer) {
            super(observer);
        }
    }
    ...
    private static class TimeAndSizeBasedBuffers<T> extends Buffers<T> {
        ...
        public TimeAndSizeBasedBuffers(Observer<? super List<T>> observer, int maxSize, long maxTime, TimeUnit unit, Scheduler scheduler) {
            super(observer);
    ...
    private static class TimeBasedBuffers<T> extends OverlappingBuffers<T> {
        ...
        public TimeBasedBuffers(Observer<? super List<T>> observer, long time, TimeUnit unit, Scheduler scheduler) {
            super(observer);
            this.time = time;
            this.unit = unit;
            this.scheduler = scheduler;
    ...
    private static class SizeBasedBuffers<T> extends Buffers<T> {
        ...
        public SizeBasedBuffers(Observer<? super List<T>> observer, int size) {
            super(observer);
            this.size = size;
        }
    ...
    private static class Buffers<T> {
         ...
         */
        public Buffers(Observer<? super List<T>> observer) {
            this.observer = observer;
        }
