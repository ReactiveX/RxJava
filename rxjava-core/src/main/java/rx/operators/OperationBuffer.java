...
public final class OperationBuffer extends ChunkedOperation {
    ...
    public static final Func0 BUFFER_MAKER = new Func0() {
        @Override
        public Object call() {
            return new Buffer();
        }
     ...
     * constructed using the {@link Func0} argument, produces a {@link rx.util.Closing} value. The buffer is then
     ...
     */
    public static <T> Func1<Observer<List<T>>, Subscription> buffer(final Observable<T> source, final Func0<Observable<Closing>> bufferClosingSelector) {
     ...
     *            the {@link Func1} object representing the specified buffer operation.
     */
    public static <T> Func1<Observer<List<T>>, Subscription> buffer(final Observable<T> source, final Observable<Opening> bufferOpenings, final Func1<Opening, Observable<Closing>> bufferClosingSelector) {
        return new Func1<Observer<List<T>>, Subscription>() {
            @Override
            public Subscription call(final Observer<List<T>> observer) {
