...
public final class OperationScan {
    ...
    private static class AccuWithoutInitialValue<T> implements IObservable<T> {
        ...
        private AccuWithoutInitialValue(IObservable<? extends T> sequence, Func2<T, T, T> accumulator) {
    ...
    private static class Accumulator<T, R> implements IObservable<R> {
        ...
        private Accumulator(IObservable<? extends T> sequence, R initialValue, Func2<R, ? super T, R> accumulator) {
            this.sequence = sequence;
