...
import rx.observers.LatchedObserver;
...
public final class OperationForEachFuture {
    ...
    public static <T> FutureTask<Void> forEachFuture(
        ...
        return forEachFuture(source, onNext, Actions.emptyThrowable(), Actions.empty());
    }
    ...
    public static <T> FutureTask<Void> forEachFuture(
        ...
        return forEachFuture(source, onNext, onError, Actions.empty());
    }
