...
public class ObservableCreatePerformance extends AbstractPerformanceTester {
    ...
    public long timeCreateAndSubscribe() {
        ...
        Observable<Long> s = Observable.create(new Action2<Observer<? super Long>, OperatorSubscription>() {

            @Override
            public void call(Observer<? super Long> o, OperatorSubscription t2) {
                o.onNext(1L);
                o.onCompleted();
            }
