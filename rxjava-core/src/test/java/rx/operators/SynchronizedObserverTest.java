...
public class SynchronizedObserverTest {
     ...
     */
    private static class TestSingleThreadedObservable implements IObservable<String> {
     ...
     */
    private static class TestMultiThreadedObservable implements IObservable<String> {
