...
public class OperationConditionalsTest {
    ...
    public void testSimple() {
        ...
        Observable<Integer> result = Observable.switchCase(func, map);
    ...
    public void testDefaultCase() {
        ...
        Observable<Integer> result = Observable.switchCase(func, map, source2);
    ...
    public void testCaseSelectorThrows() {
        ...
        Observable<Integer> result = Observable.switchCase(funcError, map);
    ...
    public void testIfThen() {
        ...
        Observable<Integer> result = Observable.ifThen(condition, source1);
    ...
    public void testIfThenElse() {
        ...
        Observable<Integer> result = Observable.ifThen(condition, source1, source2);
    ...
    public void testIfThenConditonThrows() {
        ...
        Observable<Integer> result = Observable.ifThen(conditionError, source1);
    ...
    public void testDoWhile() {
        ...
        Observable<Integer> result = source1.doWhile(condition);
    ...
    public void testDoWhileConditionThrows() {
        Observable<Integer> source1 = Observable.from(1, 2, 3);
        Observable<Integer> result = source1.doWhile(conditionError);
    ...
    public void testDoWhileManyTimes() {
        ...
        Observable<Integer> result = source1.doWhile(countdown(numRecursion));
    ...
    public void testWhileDo() {
        Observable<Integer> source1 = Observable.from(1, 2, 3);
        Observable<Integer> result = source1.whileDo(countdown(2));
    ...
    public void testWhileDoOnce() {
        Observable<Integer> source1 = Observable.from(1, 2, 3);
        Observable<Integer> result = source1.whileDo(countdown(1));
    ...
    public void testWhileDoZeroTimes() {
        Observable<Integer> source1 = Observable.from(1, 2, 3);
        Observable<Integer> result = source1.whileDo(countdown(0));
    ...
    public void testWhileDoManyTimes() {
        ...
        Observable<Integer> result = source1.whileDo(countdown(numRecursion));
    ...
    public void testWhileDoConditionThrows() {
        Observable<Integer> source1 = Observable.from(1, 2, 3);
        Observable<Integer> result = source1.whileDo(conditionError);
    ...
    public void testWhileDoSourceThrows() {
        ...
        Observable<Integer> result = source1.whileDo(condition);
