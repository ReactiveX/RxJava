...
public class OperationForEachFutureTest {
    ...
    public void testSimple() {
        ...
        try {
            ...
            FutureTask<Void> task = source.toBlockingObservable().forEachFuture(add);
    ...
    public void testSimpleScheduled() {
        ...
        FutureTask<Void> task = source.toBlockingObservable().forEachFuture(add, Schedulers.newThread());
