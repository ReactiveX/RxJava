...
public class NbpCovarianceTest {
    ...
    public void testCovarianceOfCompose2() {
        NbpObservable<Movie> movie = NbpObservable.just(new HorrorMovie());
    ...
    public void testCovarianceOfCompose3() {
        NbpObservable<Movie> movie = NbpObservable.just(new HorrorMovie());
        NbpObservable<HorrorMovie> movie2 = movie.compose(t -> NbpObservable.just(new HorrorMovie()).map(v -> v)
        );
    }
    ...
    static NbpTransformer<List<Movie>, Movie> deltaTransformer = movieList -> movieList
