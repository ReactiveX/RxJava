...
public class NbpObservableTests {
    ...
    public void testCountError() {
        NbpObservable<String> o = NbpObservable.error(() -> {
    ...
    public void testReduce() {
        ...
        o.reduce((t1, t2) -> t1 + t2).subscribe(w);
        // we should be called only once
        verify(w, times(1)).onNext(anyInt());
        verify(w).onNext(10);
    }
    ...
    public void testReduceWithEmptyNbpObservableAndSeed() {
        NbpObservable<Integer> o = NbpObservable.range(1, 0);
        int value = o.reduce(1, (t1, t2) -> t1 + t2).toBlocking().last();
    ...
    public void testCustomNbpObservableWithErrorInNbpObservableSynchronous() {
        ...
        final AtomicReference<Throwable> error = new AtomicReference<>();
        // FIXME custom built???
        NbpObservable.just("1", "2").concatWith(NbpObservable.error(NumberFormatException::new))
    ...
    public void testErrorThrownWithoutErrorHandlerAsynchronous() throws InterruptedException {
        ...
        NbpObservable.create(observer -> new Thread(() -> {
            try {
...
//    }
    ...
    public void testCompose() {
        ...
        NbpObservable.just(1, 2, 3).compose(t1 -> t1.map(v -> String.valueOf(v)))
        .subscribe(ts);
        ts.assertTerminated();
        ts.assertNoErrors();
