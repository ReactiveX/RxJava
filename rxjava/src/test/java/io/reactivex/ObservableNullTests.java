...
public class ObservableNullTests {
    ...
    public void fromFutureTimedUnitNull() {
        Observable.fromFuture(new FutureTask<>(Functions.emptyRunnable(), null), 1, null);
    }
    
    @Test(expected = NullPointerException.class)
    public void fromFutureTimedSchedulerNull() {
        Observable.fromFuture(new FutureTask<>(Functions.emptyRunnable(), null), 1, TimeUnit.SECONDS, null);
    }
    ...
    public void fromFutureSchedulerNull() {
        Observable.fromFuture(new FutureTask<>(Functions.emptyRunnable(), null), null);
    }
