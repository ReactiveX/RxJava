...
public class NbpOperatorFlatMapTest {
    @Test
    public void testNormal() {
        ...
        NbpObservable.fromIterable(source).flatMapIterable(func, resFunc).subscribe(o);
    ...
    public void testMergeError() {
        ...
        NbpObservable.fromIterable(source).flatMap(func, resFunc).subscribe(o);
    ...
    public void testFlatMapTransformsNormal() {
        NbpObservable<Integer> onNext = NbpObservable.fromIterable(Arrays.asList(1, 2, 3));
    ...
    public void testFlatMapTransformsMergeException() {
        NbpObservable<Integer> onNext = NbpObservable.error(new TestException());
        NbpObservable<Integer> onCompleted = NbpObservable.fromIterable(Arrays.asList(4));
        NbpObservable<Integer> onError = NbpObservable.fromIterable(Arrays.asList(5));
    ...
    public void testFlatMapTransformsMaxConcurrentNormal() {
        final int m = 2;
        final AtomicInteger subscriptionCount = new AtomicInteger();
        NbpObservable<Integer> onNext = 
                composer(
                        NbpObservable.fromIterable(Arrays.asList(1, 2, 3))
        ...
        NbpObservable<Integer> onCompleted = composer(NbpObservable.fromIterable(Arrays.asList(4)), subscriptionCount, m)
                .subscribeOn(Schedulers.computation());
        ...
        Function<Throwable, NbpObservable<Integer>> just = just(onError);
        ...
        for (int i = 0; i < 2000; i++) {
            ...
            .flatMap(new Function<Integer, NbpObservable<Integer>>() {
                ...
                public NbpObservable<Integer> apply(Integer t) {
                    NbpObservable<Integer> r = NbpObservable.just(t);
                    if (rnd.nextBoolean()) {
                        r = r.asObservable();
                    }
                    return r;
