...
public class OperatorSkipTest {
    ...
    public void testSkipZeroElements() {
        ...
        Observable<String> skip = Observable.just("one", "two", "three").lift(new OperatorSkip<>(0));
    ...
    public void testSkipOneElement() {
        ...
        Observable<String> skip = Observable.just("one", "two", "three").lift(new OperatorSkip<>(1));
    ...
    public void testSkipTwoElements() {
        ...
        Observable<String> skip = Observable.just("one", "two", "three").lift(new OperatorSkip<>(2));
    ...
    public void testSkipEmptyStream() {
        ...
        Observable<String> skip = w.lift(new OperatorSkip<>(1));
    ...
    public void testSkipError() {
        ...
        Observable<String> skip = Observable.concat(ok, error).lift(new OperatorSkip<>(100));
