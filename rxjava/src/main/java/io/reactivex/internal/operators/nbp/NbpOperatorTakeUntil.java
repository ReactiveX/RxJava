...
public final class NbpOperatorTakeUntil<T, U> implements NbpOperator<T, T> {
    ...
    public NbpSubscriber<? super T> apply(NbpSubscriber<? super T> child) {
        final NbpSerializedSubscriber<T> serial = new NbpSerializedSubscriber<>(child);
        
        final ArrayCompositeResource<Disposable> frc = new ArrayCompositeResource<>(2, Disposables.consumeAndDispose());
