...
public final class NbpOperatorReplay<T> extends NbpConnectableObservable<T> {
    ...
    public static <U, R> NbpObservable<R> multicastSelector(
        ...
        return NbpObservable.create(child -> {
            ...
            final NbpSubscriberResourceWrapper<R, Disposable> srw = new NbpSubscriberResourceWrapper<>(child, Disposables.consumeAndDispose());
    ...
    public static <T> NbpConnectableObservable<T> observeOn(final NbpConnectableObservable<T> co, final Scheduler scheduler) {
        ...
        return new NbpConnectableObservable<T>(observable::subscribe) {
            @Override
    ...
    @SuppressWarnings("rawtypes")
    static final class ReplaySubscriber<T> implements NbpSubscriber<T>, Disposable {
    ...
    static final class InnerSubscription<T> implements Disposable {
        ...
        public InnerSubscription(ReplaySubscriber<T> parent, NbpSubscriber<? super T> child) {
            this.parent = parent;
            this.child = child;
        }
    ...
    static final class UnboundedReplayBuffer<T> extends ArrayList<Object> implements ReplayBuffer<T> {
        ...
        public void replay(InnerSubscription<T> output) {
            ...
            final NbpSubscriber<? super T> child = output.child;
