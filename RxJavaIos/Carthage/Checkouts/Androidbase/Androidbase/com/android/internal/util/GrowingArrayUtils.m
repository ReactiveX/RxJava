...
#include "com/android/internal/util/GrowingArrayUtils.h"
...
IOSObjectArray *ComAndroidInternalUtilGrowingArrayUtils_appendWithNSObjectArray_withInt_withId_(IOSObjectArray *array, jint currentSize, id element) {
  ...
  if (currentSize + 1 > array->size_) {
    IOSObjectArray *newArray = ComAndroidInternalUtilArrayUtils_newUnpaddedArrayWithIOSClass_withInt_([[array getClass] getComponentType], ComAndroidInternalUtilGrowingArrayUtils_growSizeWithInt_(currentSize));
