...
public class FlowableFlatMapMaybeEmptyPerf {
    ...
    public void setup() {
        ...
        flowableConvert = source.flatMap(v -> Maybe.<Integer>empty().toFlowable());

        flowableDedicated = source.flatMapMaybe((Function<Integer, Maybe<? extends Integer>>) v -> Maybe.empty());
    }
