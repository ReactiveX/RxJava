...
public class ObservableSwitchMapCompletablePerf {
    ...
    public void setup() {
        ...
        observableConvert = source.switchMap((Function<Integer, Observable<Integer>>) _ -> Completable.complete().toObservable());

        observableDedicated = source.switchMapCompletable((Function<Integer, Completable>) _ -> Completable.complete());
    }
