 ...
 */
public final class CachedObservable<T> extends Flowable<T> {
     ...
     */
    public static <T> CachedObservable<T> from(Flowable<? extends T> source) {
     ...
     * @return the CachedObservable instance
     */
    public static <T> CachedObservable<T> from(Flowable<? extends T> source, int capacityHint) {
        if (capacityHint < 1) {
