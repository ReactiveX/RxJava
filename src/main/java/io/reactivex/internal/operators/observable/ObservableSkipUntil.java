...
public final class ObservableSkipUntil<T, U> extends AbstractObservableWithUpstream<T, T> {
    ...
    public void subscribeActual(Observer<? super T> child) {
        ...
        other.subscribe(new OnSubscribeObserver(frc, sus, serial));
    ...
    private final class OnSubscribeObserver implements Observer<U> {
        ...
        public OnSubscribeObserver(ArrayCompositeDisposable frc, SkipUntilObserver<T> sus, SerializedObserver<T> serial) {
            this.frc = frc;
            this.sus = sus;
            this.serial = serial;
        }
