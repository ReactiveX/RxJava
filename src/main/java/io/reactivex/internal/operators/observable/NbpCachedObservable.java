...
public final class NbpCachedObservable<T> extends Observable<T> {
     ...
     */
    public static <T> NbpCachedObservable<T> from(Observable<? extends T> source) {
     ...
     * @return the CachedObservable instance
     */
    public static <T> NbpCachedObservable<T> from(Observable<? extends T> source, int capacityHint) {
        if (capacityHint < 1) {
