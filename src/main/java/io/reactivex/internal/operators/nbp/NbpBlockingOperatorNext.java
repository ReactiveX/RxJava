 ...
 */
public enum NbpBlockingOperatorNext {
    ;
    /**
    ...
    /* private */static final class NextIterator<T> implements Iterator<T> {
        ...
        private final NbpNextObserver<T> observer;
        private final NbpObservable<? extends T> items;
        private T next;
        ...
        private NextIterator(NbpObservable<? extends T> items, NbpNextObserver<T> observer) {
            this.items = items;
        ...
        private boolean moveToNext() {
            try {
                if (!started) {
                    ...
                    NbpObservable<T> nbpObservable = (NbpObservable<T>)items;
