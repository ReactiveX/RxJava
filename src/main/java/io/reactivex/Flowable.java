...
public abstract class Flowable<T> implements Publisher<T> {
     ...
     * @param sources an Iterable of Publishers sources competing to react first. A subscription to each Publisher will
     ...
     *
     * @param <T>     the common element type
     * @param sources an array of Publisher sources competing to react first. A subscription to each Publisher will
     *                occur in the same order as in this Iterable.
     * @return a Flowable that emits the same sequence as whichever of the source Publishers first
     * emitted an item or sent a termination notification
     * @see <a href="http://reactivex.io/documentation/operators/amb.html">ReactiveX operators documentation: Amb</a>
     ...
     * @param sources  the collection of source Publishers
     * @param combiner the aggregation function used to combine the items emitted by the source Publishers
     ...
     * @param sources    the collection of source Publishers
     * @param combiner   the aggregation function used to combine the items emitted by the source Publishers
     * @param bufferSize the internal buffer size and prefetch amount applied to every source Flowable
     * @return a Flowable that emits items that are the result of combining the items emitted by the source
     * Publishers by means of the given aggregation function
     * @see <a href="http://reactivex.io/documentation/operators/combinelatest.html">ReactiveX operators documentation: CombineLatest</a>
     */
     ...
     * @param sources    the collection of source Publishers
     * @param combiner   the aggregation function used to combine the items emitted by the source Publishers
     * @param bufferSize the internal buffer size and prefetch amount applied to every source Publisher
     * @return a Flowable that emits items that are the result of combining the items emitted by the source
     * Publishers by means of the given aggregation function
     * @see <a href="http://reactivex.io/documentation/operators/combinelatest.html">ReactiveX operators documentation: CombineLatest</a>
     */
     ...
     * @param source1  the first source Publisher
     * @param source2  the second source Publisher
     * @param combiner the aggregation function used to combine the items emitted by the source Publishers
     * @return a Flowable that emits items that are the result of combining the items emitted by the source
     * Publishers by means of the given aggregation function
     * @see <a href="http://reactivex.io/documentation/operators/combinelatest.html">ReactiveX operators documentation: CombineLatest</a>
     ...
     * @param source1  the first source Publisher
     * @param source2  the second source Publisher
     * @param source3  the third source Publisher
     * @param combiner the aggregation function used to combine the items emitted by the source Publishers
     * @return a Flowable that emits items that are the result of combining the items emitted by the source
     * Publishers by means of the given aggregation function
     * @see <a href="http://reactivex.io/documentation/operators/combinelatest.html">ReactiveX operators documentation: CombineLatest</a>
     ...
     * @param source2  the second source Publisher
     * @param source3  the third source Publisher
     * @param source4  the fourth source Publisher
     * @param combiner the aggregation function used to combine the items emitted by the source Publishers
     * @return a Flowable that emits items that are the result of combining the items emitted by the source
     * Publishers by means of the given aggregation function
     * @see <a href="http://reactivex.io/documentation/operators/combinelatest.html">ReactiveX operators documentation: CombineLatest</a>
     ...
     * @param source3  the third source Publisher
     * @param source4  the fourth source Publisher
     * @param source5  the fifth source Publisher
     * @param combiner the aggregation function used to combine the items emitted by the source Publishers
     * @return a Flowable that emits items that are the result of combining the items emitted by the source
     * Publishers by means of the given aggregation function
     * @see <a href="http://reactivex.io/documentation/operators/combinelatest.html">ReactiveX operators documentation: CombineLatest</a>
     ...
     * @param source4  the fourth source Publisher
     * @param source5  the fifth source Publisher
     * @param source6  the sixth source Publisher
     * @param combiner the aggregation function used to combine the items emitted by the source Publishers
     * @return a Flowable that emits items that are the result of combining the items emitted by the source
     * Publishers by means of the given aggregation function
     * @see <a href="http://reactivex.io/documentation/operators/combinelatest.html">ReactiveX operators documentation: CombineLatest</a>
     ...
     * @param source5  the fifth source Publisher
     * @param source6  the sixth source Publisher
     * @param source7  the seventh source Publisher
     * @param combiner the aggregation function used to combine the items emitted by the source Publishers
     * @return a Flowable that emits items that are the result of combining the items emitted by the source
     * Publishers by means of the given aggregation function
     * @see <a href="http://reactivex.io/documentation/operators/combinelatest.html">ReactiveX operators documentation: CombineLatest</a>
     ...
     * @param source6  the sixth source Publisher
     * @param source7  the seventh source Publisher
     * @param source8  the eighth source Publisher
     * @param combiner the aggregation function used to combine the items emitted by the source Publishers
     * @return a Flowable that emits items that are the result of combining the items emitted by the source
     * Publishers by means of the given aggregation function
     * @see <a href="http://reactivex.io/documentation/operators/combinelatest.html">ReactiveX operators documentation: CombineLatest</a>
     ...
     * @param source7  the seventh source Publisher
     * @param source8  the eighth source Publisher
     * @param source9  the ninth source Publisher
     * @param combiner the aggregation function used to combine the items emitted by the source Publishers
     * @return a Flowable that emits items that are the result of combining the items emitted by the source
     * Publishers by means of the given aggregation function
     * @see <a href="http://reactivex.io/documentation/operators/combinelatest.html">ReactiveX operators documentation: CombineLatest</a>
     ...
     * @param sources a Publisher that emits Publishers
     ...
     * @param <T>      the common element base type
     * @param sources  a Publisher that emits Publishers
     * @param prefetch the number of Publishers to prefetch from the sources sequence.
     * @return a Flowable that emits items all of the items emitted by the Publishers emitted by
     * {@code Publishers}, one after the other, without interleaving them
     * @see <a href="http://reactivex.io/documentation/operators/concat.html">ReactiveX operators documentation: Concat</a>
     */
     ...
     *
     * @param <T>     the common element base type
     * @param source1 a Publisher to be concatenated
     * @param source2 a Publisher to be concatenated
     ...
     * @param source1 a Publisher to be concatenated
     * @param source2 a Publisher to be concatenated
     * @param source3 a Publisher to be concatenated
     ...
     * @param source2 a Publisher to be concatenated
     * @param source3 a Publisher to be concatenated
     * @param source4 a Publisher to be concatenated
     ...
     * </dl>
     *
     * @param supplier the Publisher factory function to invoke for each {@link Subscriber} that subscribes to the
     *                 resulting Publisher
     * @param <T>      the type of the items emitted by the Publisher
     ...
     * </dl>
     *
     * @param <T> the type of the items (ostensibly) emitted by the Publisher
     ...
     * </dl>
     *
     * @param supplier a Callable factory to return a Throwable for each individual Subscriber
     * @param <T>      the type of the items (ostensibly) emitted by the Publisher
     ...
     * </dl>
     *
     * @param throwable the particular Throwable to pass to {@link Subscriber#onError onError}
     * @param <T>       the type of the items (ostensibly) emitted by the Publisher
     * @return a Flowable that invokes the {@link Subscriber}'s {@link Subscriber#onError onError} method when
     * the Subscriber subscribes to it
     * @see <a href="http://reactivex.io/documentation/operators/empty-never-throw.html">ReactiveX operators documentation: Throw</a>
     ...
     * @param <T>   the type of items in the Array and the type of items to be emitted by the resulting Publisher
     ...
     * @param <T>      the type of the item emitted by the Publisher
     ...
     *
     * @param <T>            the common element base type
     * @param sources        the Iterable of Publishers
     * @param maxConcurrency the maximum number of Publishers that may be subscribed to concurrently
     * @param bufferSize     the number of items to prefetch from each inner Publisher
     ...
     *
     * @param <T>            the common element base type
     * @param sources        the array of Publishers
     * @param maxConcurrency the maximum number of Publishers that may be subscribed to concurrently
     * @param bufferSize     the number of items to prefetch from each inner Publisher
     * @return a Flowable that emits items that are the result of flattening the items emitted by the
     * Publishers in the Iterable
     ...
     *
     * @param <T>     the common element base type
     * @param source1 a Publisher to be merged
     * @param source2 a Publisher to be merged
     ...
     * @param source1 a Publisher to be merged
     * @param source2 a Publisher to be merged
     * @param source3 a Publisher to be merged
     * @return a Flowable that emits all of the items emitted by the source Publishers
     * @see <a href="http://reactivex.io/documentation/operators/merge.html">ReactiveX operators documentation: Merge</a>
     ...
     * @param source2 a Publisher to be merged
     * @param source3 a Publisher to be merged
     * @param source4 a Publisher to be merged
     * @return a Flowable that emits all of the items emitted by the source Publishers
     * @see <a href="http://reactivex.io/documentation/operators/merge.html">ReactiveX operators documentation: Merge</a>
     ...
     * </dl>
     *
     * @param <T> the type of items (not) emitted by the Publisher
    ...
    public static Flowable<Integer> range(int start, int count) {
        if (count < 0) {
            ...
            return just(start);
        } else if ((long) start + (count - 1) > Integer.MAX_VALUE) {
     ...
     * @param source2    the second Publisher to compare
     * @param isEqual    a function used to compare items emitted by each Publisher
     * @param bufferSize the number of items to prefetch from the first and second source Publisher
     * @param <T>        the type of items emitted by each Publisher
     * @return a Single that emits a Boolean value that indicates whether the two Publisher sequences
     * are the same according to the specified function
     * @see <a href="http://reactivex.io/documentation/operators/sequenceequal.html">ReactiveX operators documentation: SequenceEqual</a>
     ...
     * @param sources    the source Publisher that emits Publishers
     * @param bufferSize the number of items to prefetch from the inner Publishers
     ...
     * @param <T>      the item type
     * @param sources  the source Publisher that emits Publishers
     * @param prefetch the number of items to prefetch from the inner Publishers
     * @return a Flowable that emits the items emitted by the Publisher most recently emitted by the source
     * Publisher
     * @see <a href="http://reactivex.io/documentation/operators/switch.html">ReactiveX operators documentation: Switch</a>
     * @since 2.0
     ...
     * @param resourceSupplier the factory function to create a resource object that depends on the Publisher
     * @param sourceSupplier   the factory function to create a Publisher
     * @param resourceDisposer the function that will dispose of the resource
     ...
     * @param sourceSupplier   the factory function to create a Publisher
     * @param resourceDisposer the function that will dispose of the resource
     * @param eager            if {@code true} then disposal will happen either on cancellation or just before emission of
     ...
     * @param sources an Iterable of source Publishers
     * @param zipper  a function that, when applied to an item emitted by each of the source Publishers, results in
     ...
     * @param <R>     the zipped result type
     * @param sources a Publisher of source Publishers
     * @param zipper  a function that, when applied to an item emitted by each of the Publishers emitted by
     ...
     * @param <R>     the zipped result type
     * @param source1 the first source Publisher
     * @param source2 a second source Publisher
     * @param zipper  a function that, when applied to an item emitted by each of the source Publishers, results
     ...
     * @param source1 the first source Publisher
     * @param source2 a second source Publisher
     * @param source3 a third source Publisher
     * @param zipper  a function that, when applied to an item emitted by each of the source Publishers, results in
     *                an item that will be emitted by the resulting Publisher
     * @return a Flowable that emits the zipped results
     * @see <a href="http://reactivex.io/documentation/operators/zip.html">ReactiveX operators documentation: Zip</a>
     ...
     * @param source2 a second source Publisher
     * @param source3 a third source Publisher
     * @param source4 a fourth source Publisher
     * @param zipper  a function that, when applied to an item emitted by each of the source Publishers, results in
     *                an item that will be emitted by the resulting Publisher
     * @return a Flowable that emits the zipped results
     * @see <a href="http://reactivex.io/documentation/operators/zip.html">ReactiveX operators documentation: Zip</a>
     ...
     * @param source3 a third source Publisher
     * @param source4 a fourth source Publisher
     * @param source5 a fifth source Publisher
     * @param zipper  a function that, when applied to an item emitted by each of the source Publishers, results in
     *                an item that will be emitted by the resulting Publisher
     * @return a Flowable that emits the zipped results
     * @see <a href="http://reactivex.io/documentation/operators/zip.html">ReactiveX operators documentation: Zip</a>
     ...
     * @param source4 a fourth source Publisher
     * @param source5 a fifth source Publisher
     * @param source6 a sixth source Publisher
     * @param zipper  a function that, when applied to an item emitted by each of the source Publishers, results in
     *                an item that will be emitted by the resulting Publisher
     * @return a Flowable that emits the zipped results
     * @see <a href="http://reactivex.io/documentation/operators/zip.html">ReactiveX operators documentation: Zip</a>
     ...
     * @param source5 a fifth source Publisher
     * @param source6 a sixth source Publisher
     * @param source7 a seventh source Publisher
     * @param zipper  a function that, when applied to an item emitted by each of the source Publishers, results in
     *                an item that will be emitted by the resulting Publisher
     * @return a Flowable that emits the zipped results
     * @see <a href="http://reactivex.io/documentation/operators/zip.html">ReactiveX operators documentation: Zip</a>
     ...
     * @param source6 a sixth source Publisher
     * @param source7 a seventh source Publisher
     * @param source8 an eighth source Publisher
     * @param zipper  a function that, when applied to an item emitted by each of the source Publishers, results in
     *                an item that will be emitted by the resulting Publisher
     * @return a Flowable that emits the zipped results
     * @see <a href="http://reactivex.io/documentation/operators/zip.html">ReactiveX operators documentation: Zip</a>
     ...
     * @param source7 a seventh source Publisher
     * @param source8 an eighth source Publisher
     * @param source9 a ninth source Publisher
     * @param zipper  a function that, when applied to an item emitted by each of the source Publishers, results in
     *                an item that will be emitted by the resulting Publisher
     * @return a Flowable that emits the zipped results
     * @see <a href="http://reactivex.io/documentation/operators/zip.html">ReactiveX operators documentation: Zip</a>
     ...
     * @param <T>        the common element type
     * @param <R>        the result type
     * @param sources    an array of source Publishers
     * @param zipper     a function that, when applied to an item emitted by each of the source Publishers, results in
     *                   an item that will be emitted by the resulting Publisher
     * @param delayError delay errors signaled by any of the source Publisher until all Publishers terminate
     * @param bufferSize the number of elements to prefetch from each source Publisher
     * @return a Flowable that emits the zipped results
     * @see <a href="http://reactivex.io/documentation/operators/zip.html">ReactiveX operators documentation: Zip</a>
     */
     ...
     * </dl>
     *
     * @param other a Publisher competing to react first. A subscription to this provided Publisher will occur after subscribing
     ...
     * </dl>
     *
     * @param predicate the condition to test items emitted by the source Publisher
     ...
     * @throws NoSuchElementException if this {@code Flowable} emits no items
     ...
     * </dl>
     *
     * @param defaultItem a default value to return if this {@code Flowable} emits no items
     ...
     * </dl>
     *
     * @param onNext the {@link Consumer} to invoke for each item emitted by the {@code Flowable}
     ...
     * </dl>
     *
     * @param initialItem the initial item that the {@link Iterable} sequence will yield if this
     ...
     * @param skip  how many items emitted by the source Publisher should be skipped before starting a new
     ...
     * @param openingIndicator the Publisher that, when it emits an item, causes a new buffer to be created
     * @param closingIndicator the {@link Function} that is used to produce a Publisher for every buffer created. When this
     ...
     * @param boundaryIndicator the boundary Publisher
     ...
     * @param boundaryIndicatorSupplier a {@link Callable} that produces a Publisher that governs the boundary between buffers.
     ...
     * @param clazz the target class type that {@code cast} will cast the items emitted by the source Publisher
     ...
     * @param mapper a function that, when applied to an item emitted by the source Publisher, returns a
     *               Publisher
     ...
     * @param mapper   a function that, when applied to an item emitted by the source Publisher, returns a
     *                 Publisher
     * @param prefetch the number of elements to prefetch from the current Flowable
     * @return a Flowable that emits the result of applying the transformation function to each item emitted
     * by the source Publisher and concatenating the Publishers obtained from this transformation
     * @see <a href="http://reactivex.io/documentation/operators/flatmap.html">ReactiveX operators documentation: FlatMap</a>
     */
     ...
     * @param mapper     the function that maps the items of this Publisher into the inner Publishers.
     * @param prefetch   the number of elements to prefetch from the current Flowable
     * @param tillTheEnd if true, all errors from the outer and inner Publisher sources are delayed until the end,
     ...
     *                       eagerly concatenated
     * @param maxConcurrency the maximum number of concurrent subscribed Publishers
     * @param prefetch       the number of elements to prefetch from each source Publisher
     * @param tillTheEnd     if true, exceptions from the current Flowable and all the inner Publishers are delayed until
     ...
     * </dl>
     *
     * @param <U>    the type of item emitted by the resulting Publisher
     ...
     * </dl>
     *
     * @param other a Publisher to be concatenated after the current
     * @return a Flowable that emits items emitted by the two source Publishers, one after the other,
     * without interleaving them
     * @see <a href="http://reactivex.io/documentation/operators/concat.html">ReactiveX operators documentation: Concat</a>
     */
     ...
     * </dl>
     *
     * @param item the item to search for in the emissions from the source Publisher
     ...
     * @param debounceIndicator function to retrieve a sequence that indicates the throttle duration for each item
     ...
     * </dl>
     *
     * @param timeout the time each item has to be "the most recent" of those emitted by the source Publisher to
     ...
     * </dl>
     *
     * @param defaultItem the item to emit if the source Publisher emits no items
     ...
     * @param itemDelayIndicator a function that returns a Publisher for each item emitted by the source Publisher, which is
     ...
     * @param delay      the delay to shift the source by
     * @param unit       the {@link TimeUnit} in which {@code period} is defined
     * @param delayError if true, the upstream exception is signaled with the given delay, after all preceding normal elements,
     ...
     * @param subscriptionIndicator a function that returns a Publisher that triggers the subscription to the source Publisher
     ...
     * @param keySelector        a function that projects an emitted item to a key value that is used to decide whether an item
     *                           is distinct from another one or not
     * @param collectionSupplier function called for each individual Subscriber to return a Collection subtype for holding the extracted
     ...
     * </dl>
     *
     * @param onAfterTerminate an {@link Action} to be invoked when the source Publisher finishes
     ...
     * </dl>
     *
     * @param onCancel the action that gets called when the source {@code Publisher}'s Subscription is canceled
     ...
     * </dl>
     *
     * @param onComplete the action to invoke when the source Publisher calls {@code onComplete}
     ...
     * </dl>
     *
     * @param onNotification the action to invoke for each item emitted by the source Publisher
     * @return the source Publisher with the side-effecting behavior applied
     * @see <a href="http://reactivex.io/documentation/operators/do.html">ReactiveX operators documentation: Do</a>
     */
    @CheckReturnValue
     ...
     * </dl>
     *
     * @param subscriber the Subscriber to be notified about onNext, onError and onComplete events on its
     ...
     * </dl>
     *
     * @param onSubscribe a Consumer called with the Subscription sent via Subscriber.onSubscribe()
     * @param onRequest   a LongConsumer called with the request amount sent via Subscription.request()
     * @param onCancel    called when the downstream cancels the Subscription via cancel()
     * @return the source Publisher with the side-effecting behavior applied
     * @see <a href="http://reactivex.io/documentation/operators/do.html">ReactiveX operators documentation: Do</a>
     */
    @CheckReturnValue
     ...
     * </dl>
     *
     * @param onNext the action to invoke when the source Publisher calls {@code onNext}
     * @return the source Publisher with the side-effecting behavior applied
     * @see <a href="http://reactivex.io/documentation/operators/do.html">ReactiveX operators documentation: Do</a>
     */
    @CheckReturnValue
     ...
     * </dl>
     *
     * @param onRequest the action that gets called when a Subscriber requests items from this
     *                  {@code Publisher}
     * @return the source {@code Publisher} modified so as to call this Action when appropriate
     ...
     * </dl>
     *
     * @param onSubscribe the Consumer that gets called when a Subscriber subscribes to the current {@code Flowable}
     ...
     * </dl>
     *
     * @param predicate a function that evaluates each item emitted by the source Publisher, returning {@code true}
     ...
     * </dl>
     *
     * @param defaultItem the default item to emit if the source Publisher doesn't emit anything
     ...
     * @param mapper      a function that, when applied to an item emitted by the source Publisher, returns a
     *                    Publisher
     * @param delayErrors if true, exceptions from the current Flowable and all inner Publishers are delayed until all of them terminate
     ...
     * @param delayErrors    if true, exceptions from the current Flowable and all inner Publishers are delayed until all of them terminate
     *                       if false, the first one signaling an exception will terminate the whole sequence immediately
     * @param bufferSize     the number of elements to prefetch from each inner Publisher
     * @return a Flowable that emits the result of applying the transformation function to each item emitted
     * by the source Publisher and merging the results of the Publishers obtained from this
     * transformation
     * @see <a href="http://reactivex.io/documentation/operators/flatmap.html">ReactiveX operators documentation: FlatMap</a>
     ...
     *
     * @param <R>                the result type
     * @param onNextMapper       a function that returns a Publisher to merge for each item emitted by the source Publisher
     * @param onErrorMapper      a function that returns a Publisher to merge for an onError notification from the source
     *                           Publisher
     * @param onCompleteSupplier a function that returns a Publisher to merge for an onComplete notification from the source
     *                           Publisher
     ...
     * </dl>
     *
     * @param <U>      the type of items emitted by the inner Publishers
     * @param <R>      the type of items emitted by the combiner function
     * @param mapper   a function that returns a Publisher for each item emitted by the source Publisher
     * @param combiner a function that combines one item emitted by each of the source and collection Publishers and
     ...
     *
     * @param <U>         the type of items emitted by the inner Publishers
     * @param <R>         the type of items emitted by the combiner functions
     * @param mapper      a function that returns a Publisher for each item emitted by the source Publisher
     * @param combiner    a function that combines one item emitted by each of the source and collection Publishers and
     *                    returns an item to be emitted by the resulting Publisher
     * @param delayErrors if true, exceptions from the current Flowable and all inner Publishers are delayed until all of them terminate
     ...
     * @param delayErrors    if true, exceptions from the current Flowable and all inner Publishers are delayed until all of them terminate
     *                       if false, the first one signaling an exception will terminate the whole sequence immediately
     * @param bufferSize     the number of elements to prefetch from the inner Publishers.
     * @return a Flowable that emits the results of applying a function to a pair of values emitted by the
     * source Publisher and the collection Publisher
     * @see <a href="http://reactivex.io/documentation/operators/flatmap.html">ReactiveX operators documentation: FlatMap</a>
     * @since 2.0
     ...
     * @param mapper     a function that returns an Iterable sequence of values for when given an item emitted by the
     *                   source Publisher
     * @param bufferSize the number of elements to prefetch from the current Flowable
     * @return a Flowable that emits the results of merging the items emitted by the source Publisher with
     * the values in the Iterables corresponding to those items, as generated by {@code collectionSelector}
     * @see <a href="http://reactivex.io/documentation/operators/flatmap.html">ReactiveX operators documentation: FlatMap</a>
     */
     ...
     *                       Publisher
     * @param resultSelector a function that returns an item based on the item emitted by the source Publisher and the
     ...
     * </dl>
     *
     * @param <U>            the element type of the inner Iterable sequences
     * @param <V>            the type of item emitted by the resulting Publisher
     * @param mapper         a function that returns an Iterable sequence of values for when given an item emitted by the
     *                       source Publisher
     * @param resultSelector a function that returns an item based on the item emitted by the source Publisher and the
     *                       Iterable returned for that item by the {@code collectionSelector}
     ...
     * @return a Disposable that allows canceling an asynchronous sequence
     ...
     * @return a {@link Disposable} that allows canceling an asynchronous sequence
     * @throws NullPointerException if {@code onNext} is null
     * @see <a href="http://reactivex.io/documentation/operators/subscribe.html">ReactiveX operators documentation: Subscribe</a>
     */
    @CheckReturnValue
     ...
     * @param onNext     {@link Predicate} to execute for each item.
     * @param onError    {@link Consumer} to execute when an error is emitted.
     * @param onComplete {@link Action} to execute when completion is signaled.
     * @return a {@link Disposable} that allows canceling an asynchronous sequence
     * @throws NullPointerException if {@code onNext} is null, or
     ...
     * @param keySelector a function that extracts the key for each item
     * @param <K>         the key type
     * @param delayError  if true, the exception from the current Flowable is delayed in each group until that specific group emitted
     ...
     * @param delayError    if true, the exception from the current Flowable is delayed in each group until that specific group emitted
     *                      the normal values; if false, the exception bypasses values in the groups and is reported immediately.
     * @param bufferSize    the hint for how many {@link GroupedFlowable}s and element in each {@link GroupedFlowable} should be buffered
     * @param <K>           the key type
     * @param <V>           the element type
     * @return a {@code Publisher} that emits {@link GroupedFlowable}s, each of which corresponds to a
     * unique key value and each of which emits those items from the source Publisher that share that
     ...
     *                           the normal values; if false, the exception bypasses values in the groups and is reported immediately.
     * @param bufferSize         the hint for how many {@link GroupedFlowable}s and element in each {@link GroupedFlowable} should be buffered
     * @param evictingMapFactory The factory used to create a map that will be used by the implementation to hold the
     ...
     * @param leftEnd        a function that returns a Publisher whose emissions indicate the duration of the values of
     *                       the source Publisher
     * @param rightEnd       a function that returns a Publisher whose emissions indicate the duration of the values of
     *                       the {@code right} Publisher
     * @param resultSelector a function that takes an item emitted by each Publisher and returns the value to be emitted
     ...
     * @param <TRightEnd>    the element type of the right duration Publishers
     * @param <R>            the result type
     * @param other          the second Publisher to join items from
     * @param leftEnd        a function to select a duration for each item emitted by the source Publisher, used to
     *                       determine overlap
     * @param rightEnd       a function to select a duration for each item emitted by the {@code right} Publisher, used to
     *                       determine overlap
     * @param resultSelector a function that computes an item to be emitted by the resulting Publisher for any two
     ...
     * </dl>
     *
     * @param defaultItem the default item to emit if the source Publisher is empty
     * @return the new Single instance
     * @see <a href="http://reactivex.io/documentation/operators/last.html">ReactiveX operators documentation: Last</a>
     */
    @CheckReturnValue
     ...
     * @param mapper a function to apply to each item emitted by the Publisher
     ...
     * </dl>
     *
     * @param other a Publisher to be merged
     * @return a Flowable that emits all of the items emitted by the source Publishers
     * @see <a href="http://reactivex.io/documentation/operators/merge.html">ReactiveX operators documentation: Merge</a>
     */
    @CheckReturnValue
     ...
     * </dl>
     *
     * @param scheduler the {@link Scheduler} to notify {@link Subscriber}s on
     ...
     * @param clazz the class type to filter the items emitted by the source Publisher
     ...
     * </dl>
     *
     * @param delayError if true, an exception from the current Flowable is delayed until all buffered elements have been
     ...
     *                   consumed by the downstream; if false, an exception is immediately signaled to the downstream, skipping
     *                   any buffered element
     * @param unbounded  if true, the capacity value is interpreted as the internal "island" size of the unbounded buffer
     * @return the source {@code Publisher} modified to buffer items up to the given capacity.
     * @see <a href="http://reactivex.io/documentation/operators/backpressure.html">ReactiveX operators documentation: backpressure operators</a>
     * @since 1.1.0
     */
     ...
     * </dl>
     *
     * @param resumeFunction a function that returns a Publisher that will take over if the source Publisher encounters
     *                       an error
     ...
     * </dl>
     *
     * @param next the next Publisher source that will take over if the source Publisher encounters
     *             an error
     * @return the original Publisher, with appropriately modified behavior
     * @see <a href="http://reactivex.io/documentation/operators/catch.html">ReactiveX operators documentation: Catch</a>
     */
     ...
     * </dl>
     *
     * @param next the next Publisher that will take over if the source Publisher encounters
     *             an exception
     * @return the original Publisher, with appropriately modified behavior
     * @see <a href="http://reactivex.io/documentation/operators/catch.html">ReactiveX operators documentation: Catch</a>
     */
     ...
     * </dl>
     *
     * @param reducer an accumulator function to be invoked on each item emitted by the source Publisher, whose
     ...
     * @param reducer an accumulator function to be invoked on each item emitted by the source Publisher, the
     ...
     *
     * @param <R>          the accumulator and output value type
     * @param seedSupplier the Callable that provides the initial (seed) accumulator value for each individual Subscriber
     * @param reducer      an accumulator function to be invoked on each item emitted by the source Publisher, the
     *                     result of which will be used in the next accumulator call
     * @return a Single that emits a single item that is the result of accumulating the output from the
     * items emitted by the source Publisher
     ...
     * </dl>
     *
     * @param times the number of times the source Publisher items are repeated, a count of 0 will yield an empty
     *              sequence
     ...
     * </dl>
     *
     * @param stop a boolean supplier that is called when the current Flowable completes and unless it returns
     ...
     * </dl>
     *
     * @param handler receives a Publisher of notifications with which a user can complete or error, aborting the repeat.
     ...
     * @param selector   the selector function, which can use the multicasted sequence as many times as needed, without
     *                   causing multiple subscriptions to the Publisher
     * @param bufferSize the buffer size that limits the number of items the connectable Publisher can replay
     ...
     *
     * @param bufferSize the buffer size that limits the number of items that can be replayed
     * @param scheduler  the scheduler on which the Subscribers will observe the emitted items
     * @return a {@link ConnectableFlowable} that shares a single subscription to the source Publisher and
     ...
     * </dl>
     *
     * @param handler receives a Publisher of notifications with which a user can complete or error, aborting the
     *                retry
     * @return the source Publisher modified with retry logic
     * @see <a href="http://reactivex.io/documentation/operators/retry.html">ReactiveX operators documentation: Retry</a>
     */
     ...
     * @param sampler the Publisher to use for sampling the source Publisher
     ...
     * </dl>
     *
     * @param accumulator an accumulator function to be invoked on each item emitted by the source Publisher, whose
     ...
     *
     * @param <R>          the initial, accumulator and result type
     * @param seedSupplier a Callable that returns the initial (seed) accumulator item for each individual Subscriber
     * @param accumulator  an accumulator function to be invoked on each item emitted by the source Publisher, whose
     *                     result will be emitted to {@link Subscriber}s via {@link Subscriber#onNext onNext} and used in the
     *                     next accumulator call
     * @return a Flowable that emits {@code initialValue} followed by the results of each call to the
     ...
     * </dl>
     *
     * @param defaultItem a default value to emit if the source Publisher emits no item
     ...
     * @param time       the length of the time window
     * @param unit       the time unit of {@code time}
     * @param delayError if true, an exception signaled by the current Flowable is delayed until the regular elements are consumed
     ...
     * @param other the second Publisher that has to emit an item before the source Publisher's elements begin
     ...
     * </dl>
     *
     * @param predicate a function to test each item emitted from the source Publisher
     ...
     * </dl>
     *
     * @param sortFunction a function that compares two items emitted by the source Publisher and returns an Integer
     ...
     * </dl>
     *
     * @param items an Iterable that contains the items you want the modified Publisher to emit first
     ...
     * </dl>
     *
     * @param other a Publisher that contains the items you want the modified Publisher to emit first
     ...
     * </dl>
     *
     * @param value the item to emit first
     ...
     * </dl>
     *
     * @param onNext the {@code Consumer<T>} you have designed to accept emissions from the Publisher
     * @return a {@link Disposable} reference with which the caller can stop receiving items before
     * the Publisher has finished sending them
     * @throws NullPointerException if {@code onNext} is null
     * @see <a href="http://reactivex.io/documentation/operators/subscribe.html">ReactiveX operators documentation: Subscribe</a>
     ...
     * @param onComplete  the {@code Action} you have designed to accept a completion notification from the
     *                    Publisher
     * @param onSubscribe the {@code Consumer} that receives the upstream's Subscription
     * @return a {@link Disposable} reference with which the caller can stop receiving items before
     * the Publisher has finished sending them
     * @throws NullPointerException if {@code onNext} is null, or
     *                              if {@code onError} is null, or
     ...
     * </dl>
     *
     * @param other the alternate Publisher to subscribe to if the source does not emit any items
     ...
     * @param mapper     a function that, when applied to an item emitted by the source Publisher, returns a
     *                   Publisher
     * @param bufferSize the number of elements to prefetch from the current active inner Publisher
     * @return a Flowable that emits the items emitted by the Publisher returned from applying {@code func} to the most recently emitted item emitted by the source Publisher
     * @see <a href="http://reactivex.io/documentation/operators/flatmap.html">ReactiveX operators documentation: FlatMap</a>
     */
    @CheckReturnValue
     ...
     * </dl>
     *
     * @param stopPredicate a function that evaluates an item emitted by the source Publisher and returns a Boolean
     ...
     * </dl>
     *
     * @param other the Publisher whose first emitted item will cause {@code takeUntil} to stop emitting items
     *              from the source Publisher
     ...
     * </dl>
     *
     * @param predicate a function that evaluates an item emitted by the source Publisher and returns a Boolean
     ...
     * </dl>
     *
     * @param intervalDuration duration of windows within which the last item emitted by the source Publisher will be
     *                         emitted
     ...
     * @param itemTimeoutIndicator a function that returns a Publisher for each item emitted by the source
     ...
     *
     * @param <V>                  the timeout value type (ignored)
     * @param itemTimeoutIndicator a function that returns a Publisher, for each item emitted by the source Publisher, that
     *                             determines the timeout window for the subsequent item
     * @param other                the fallback Publisher to switch to if the source Publisher times out
     ...
     * @param timeUnit the unit of time that applies to the {@code timeout} argument
     * @param other    the fallback Publisher to use in case of a timeout
     ...
     * @param other     the Publisher to use as the fallback in case of a timeout
     ...
     * @param firstTimeoutIndicator a function that returns a Publisher that determines the timeout window for the first source
     *                              item
     * @param itemTimeoutIndicator  a function that returns a Publisher for each item emitted by the source Publisher and that
     ...
     * @param <U>                   the first timeout value type (ignored)
     * @param <V>                   the subsequent timeout value type (ignored)
     * @param firstTimeoutIndicator a function that returns a Publisher which determines the timeout window for the first source
     *                              item
     * @param itemTimeoutIndicator  a function that returns a Publisher for each item emitted by the source Publisher and that
     *                              determines the timeout window in which the subsequent source item must arrive in order to
     *                              continue the sequence
     ...
     * @throws NullPointerException if {@code itemTimeoutIndicator} is null
     * @see <a href="http://reactivex.io/documentation/operators/timeout.html">ReactiveX operators documentation: Timeout</a>
     */
    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
     ...
     * </dl>
     *
     * @param capacityHint the number of elements expected from the current Flowable
     ...
     * @param collectionSupplier the Callable returning the collection (for each individual Subscriber) to be filled in
     * @return a Single that emits a single item: a List containing all of the items emitted by the source
     * Publisher
     * @see <a href="http://reactivex.io/documentation/operators/to.html">ReactiveX operators documentation: To</a>
     */
     ...
     * </dl>
     *
     * @param comparator a function that compares two items emitted by the source Publisher and returns an Integer
     *                   that indicates their sort order
     * @return a Single that emits a list that contains the items emitted by the source Publisher in
     * sorted order
     * @see <a href="http://reactivex.io/documentation/operators/to.html">ReactiveX operators documentation: To</a>
     ...
     * </dl>
     *
     * @param scheduler the {@link Scheduler} to perform cancellation actions on
     ...
     * @param boundaryIndicator a Publisher whose emitted items close and open windows
     ...
     * @param openingIndicator a Publisher that, when it emits an item, causes another window to be created
     * @param closingIndicator a {@link Function} that produces a Publisher for every window created. When this Publisher
     ...
     * @param boundaryIndicatorSupplier a {@link Callable} that returns a {@code Publisher} that governs the boundary between windows.
     ...
     * @param combiner the function to call when this Publisher emits an item and the other Publisher has already
     ...
     * @param zipper a function that combines the pairs of items from the Publisher and the Iterable to generate
     ...
     * </dl>
     *
     * @param <U>    the type of items emitted by the {@code other} Publisher
     * @param <R>    the type of items emitted by the resulting Publisher
     * @param other  the other Publisher
     * @param zipper a function that combines the pairs of items from the two Publishers to generate the items to
     ...
     * @param zipper     a function that combines the pairs of items from the two Publishers to generate the items to
     *                   be emitted by the resulting Publisher
     * @param delayError if true, errors from the current Flowable or the other Publisher is delayed until both terminate
     * @return a Flowable that pairs up values from the source Publisher and the {@code other} Publisher
     * and emits the results of {@code zipFunction} applied to these pairs
     * @see <a href="http://reactivex.io/documentation/operators/zip.html">ReactiveX operators documentation: Zip</a>
     * @since 2.0
