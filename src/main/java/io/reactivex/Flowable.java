...
public abstract class Flowable<T> implements Publisher<T> {
    ...
    /**
     * Returns a Flowable that emits the items emitted by five Publishers, one after the other, without
     * interleaving them.
     * <p>
     * <img width="640" height="380" src="https://raw.github.com/wiki/ReactiveX/RxJava/images/rx-operators/concat.png" alt="">
     * <dl>
     ...
     * @param p5
     *            a Publisher to be concatenated
     * @return a Flowable that emits items emitted by the five source Publishers, one after the other,
     *         without interleaving them
     * @see <a href="http://reactivex.io/documentation/operators/concat.html">ReactiveX operators documentation: Concat</a>
     */
    @SuppressWarnings("unchecked")
    ...
    /**
     * Returns a Flowable that emits the items emitted by six Publishers, one after the other, without
     * interleaving them.
     * <p>
     * <img width="640" height="380" src="https://raw.github.com/wiki/ReactiveX/RxJava/images/rx-operators/concat.png" alt="">
     * <dl>
     ...
     * @param p6
     *            a Publisher to be concatenated
     * @return a Flowable that emits items emitted by the six source Publishers, one after the other,
     *         without interleaving them
     * @see <a href="http://reactivex.io/documentation/operators/concat.html">ReactiveX operators documentation: Concat</a>
     */
    @SuppressWarnings("unchecked")
    ...
    /**
     * Returns a Flowable that emits the items emitted by seven Publishers, one after the other, without
     * interleaving them.
     * <p>
     * <img width="640" height="380" src="https://raw.github.com/wiki/ReactiveX/RxJava/images/rx-operators/concat.png" alt="">
     * <dl>
     ...
     * @param p7
     *            a Publisher to be concatenated
     * @return a Flowable that emits items emitted by the seven source Publishers, one after the other,
     *         without interleaving them
     * @see <a href="http://reactivex.io/documentation/operators/concat.html">ReactiveX operators documentation: Concat</a>
     */
    @SuppressWarnings("unchecked")
    ...
    /**
     * Returns a Flowable that emits the items emitted by eight Publishers, one after the other, without
     * interleaving them.
     * <p>
     * <img width="640" height="380" src="https://raw.github.com/wiki/ReactiveX/RxJava/images/rx-operators/concat.png" alt="">
     * <dl>
     ...
     * @param p8
     *            a Publisher to be concatenated
     * @return a Flowable that emits items emitted by the eight source Publishers, one after the other,
     *         without interleaving them
     * @see <a href="http://reactivex.io/documentation/operators/concat.html">ReactiveX operators documentation: Concat</a>
     */
    @SuppressWarnings("unchecked")
    ...
    /**
     * Returns a Flowable that emits the items emitted by nine Publishers, one after the other, without
     * interleaving them.
     * <p>
     * <img width="640" height="380" src="https://raw.github.com/wiki/ReactiveX/RxJava/images/rx-operators/concat.png" alt="">
     * <dl>
     ...
     * @param p9
     *            a Publisher to be concatenated
     * @return a Flowable that emits items emitted by the nine source Publishers, one after the other,
     *         without interleaving them
     * @see <a href="http://reactivex.io/documentation/operators/concat.html">ReactiveX operators documentation: Concat</a>
     */
    @SuppressWarnings("unchecked")
    ...
    public static <T> Flowable<T> generate(final Consumer<Subscriber<T>> generator) {
        ...
        new BiFunction<Object, Subscriber<T>, Object>() {
            @Override
            public Object apply(Object s, Subscriber<T> o) throws Exception {
                generator.accept(o);
                return s;
            }
    ...
    public static <T, S> Flowable<T> generate(Callable<S> initialState, final BiConsumer<S, Subscriber<T>> generator) {
        ...
        return generate(initialState, new BiFunction<S, Subscriber<T>, S>() {
            @Override
            public S apply(S s, Subscriber<T> o) throws Exception {
    ...
    public final Flowable<T> cacheWithInitialCapacity(int initialCapacity) {
        if (initialCapacity <= 0) {
            throw new IllegalArgumentException("capacityHint > 0 required but it was " + initialCapacity);
        }
    ...
    public final <R> Flowable<R> replay(Function<? super Flowable<T>, ? extends Publisher<R>> selector) {
        Objects.requireNonNull(selector, "selector is null");
        return FlowableReplay.multicastSelector(new Callable<ConnectableFlowable<T>>() {
            @Override
...
//            return lift(s -> CancelledSubscriber.INSTANCE);
    ...
    /**
     * Returns a Flowable that emits a single List containing at most the last {@code count} elements emitted by the
     * source Publisher. If the source emits fewer than {@code count} items then the emitted List will contain all of the source emissions.
     * <p>
     ...
     * @return a Flowable that emits a single list containing at most the last {@code count} elements emitted by the
     *         source Publisher
     * @see <a href="http://reactivex.io/documentation/operators/takelast.html">ReactiveX operators documentation: TakeLast</a>
     */
    @BackpressureSupport(BackpressureKind.FULL)
    ...
    /**
     * Returns a Flowable that emits a single List containing at most {@code count} items from the source
     * Publisher that were emitted during a specified window of time before the source Publisher completed.
     * <p>
     ...
     * @param unit
     *            the time unit of {@code time}
     * @return a Flowable that emits a single List containing at most {@code count} items emitted by the
     *         source Publisher during the time window defined by {@code time} before the source Publisher
     *         completed
     * @see <a href="http://reactivex.io/documentation/operators/takelast.html">ReactiveX operators documentation: TakeLast</a>
     */
    @BackpressureSupport(BackpressureKind.FULL)
    ...
    /**
     * Returns a Flowable that emits a single List containing at most {@code count} items from the source
     * Publisher that were emitted during a specified window of time (on a specified Scheduler) before the
     * source Publisher completed.
     * <p>
    ...
    /**
     * Returns a Flowable that emits a single List containing those items from the source Publisher that
     * were emitted during a specified window of time before the source Publisher completed.
     * <p>
     ...
     * @param unit
     *            the time unit of {@code time}
     * @return a Flowable that emits a single List containing the items emitted by the source Publisher
     *         during the time window defined by {@code time} before the source Publisher completed
     * @see <a href="http://reactivex.io/documentation/operators/takelast.html">ReactiveX operators documentation: TakeLast</a>
     */
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport(SchedulerSupport.NONE)
    ...
    /**
     * Returns a Flowable that emits a single List containing those items from the source Publisher that
     * were emitted during a specified window of time before the source Publisher completed, where the timing
     ...
     *            the Scheduler that provides the timestamps for the observed items
     * @return a Flowable that emits a single List containing the items emitted by the source Publisher
     *         during the time window defined by {@code time} before the source Publisher completed, where the
    ...
    public final Flowable<List<T>> toList(final int capacityHint) {
        ...
        return new FlowableToList<T, List<T>>(this, new Callable<List<T>>() {
            @Override
            public List<T> call() {
