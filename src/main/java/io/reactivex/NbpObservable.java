...
public class NbpObservable<T> {
    ...
    public static <T> NbpObservable<T> fromPublisher(Publisher<? extends T> NbpObservable) {
        return create(s -> {
            NbpObservable.subscribe(new Subscriber<T>() {
...
//        return create(new PublisherCompletableFutureSource<>(future));
    ...
    public static <T> NbpObservable<T> fromFuture(Future<? extends T> future) {
        ...
        Objects.requireNonNull(future);
//        NbpObservable<T> o = create(new PublisherFutureSource<>(future, 0L, null));
//        return o;
        throw new UnsupportedOperationException("To be implemented");
    }
...
//        NbpObservable<T> o = create(new PublisherFutureSource<>(future, timeout, unit));
//        return o;
        throw new UnsupportedOperationException("To be implemented");
    }
...
//        return create(new PublisherStreamSource<>(stream));
    ...
    @SchedulerSupport(SchedulerKind.NONE)
    public static <T> NbpObservable<T> generate(Consumer<Subscriber<T>> generator) {
    ...
    @SchedulerSupport(SchedulerKind.NONE)
    public static <T, S> NbpObservable<T> generate(Supplier<S> initialState, BiConsumer<S, Subscriber<T>> generator) {
        Objects.requireNonNull(generator);
    ...
    @SchedulerSupport(SchedulerKind.NONE)
    public static <T, S> NbpObservable<T> generate(Supplier<S> initialState, BiConsumer<S, Subscriber<T>> generator, Consumer<? super S> disposeState) {
        Objects.requireNonNull(generator);
        return generate(initialState, (s, o) -> {
            generator.accept(s, o);
            return s;
    ...
    @SchedulerSupport(SchedulerKind.NONE)
    public static <T, S> NbpObservable<T> generate(Supplier<S> initialState, BiFunction<S, Subscriber<T>, S> generator) {
        return generate(initialState, generator, s -> { });
    }

    @SchedulerSupport(SchedulerKind.NONE)
    public static <T, S> NbpObservable<T> generate(Supplier<S> initialState, BiFunction<S, Subscriber<T>, S> generator, Consumer<? super S> disposeState) {
...
//        return lift(new OperatorDelay<>(delay, unit, scheduler, delayError));
    ...
    public final <U> NbpObservable<T> delaySubscription(Supplier<? extends NbpObservable<U>> delaySupplier) {
        // FIXME apply fix from one of the PRs
...
//        return lift(new OperatorDoOnEach<>(onNext, onError, onComplete, onAfterTerminate));
    ...
    @SchedulerSupport(SchedulerKind.NONE)
    public final NbpObservable<T> doOnEach(Subscriber<? super T> observer) {
    ...
    @SchedulerSupport(SchedulerKind.NONE)
    public final NbpObservable<T> doOnLifecycle(Consumer<? super Subscription> onSubscribe, LongConsumer onRequest, Runnable onCancel) {
//        return lift(s -> new SubscriptionLambdaSubscriber<>(s, onSubscribe, onRequest, onCancel));
    ...
    @SchedulerSupport(SchedulerKind.NONE)
    public final NbpObservable<T> doOnRequest(LongConsumer onRequest) {
        return doOnLifecycle(s -> { }, onRequest, () -> { });
    }

    @SchedulerSupport(SchedulerKind.NONE)
    public final NbpObservable<T> doOnSubscribe(Consumer<? super Subscription> onSubscribe) {
...
//        return ls;
    ...
    @SchedulerSupport(SchedulerKind.CUSTOM)
    public final NbpObservable<T> subscribeOn(Scheduler scheduler, boolean requestOn) {
        Objects.requireNonNull(scheduler);
