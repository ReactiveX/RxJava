 ...
 * {@link io.reactivex.rxjava4.subjects.MaybeSubject MaybeSubject}.
 * <p>
 ...
 * {@link io.reactivex.rxjava4.observers.DisposableMaybeObserver DisposableMaybeObserver} instance.
 ...
 * @since 2.0
 * @see io.reactivex.rxjava4.observers.DisposableMaybeObserver
 */
public abstract class Maybe<@NonNull T> implements MaybeSource<T> {
     ...
     *  violates this, a {@link io.reactivex.rxjava4.exceptions.MissingBackpressureException} is signaled.</dd>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code concat} does not operate by default on a particular {@link Scheduler}.</dd>
     * </dl>
     * @param <T> the value type
    ...
    @NonNull
    @SchedulerSupport(SchedulerSupport.NONE)
    public static <@NonNull T> Flowable<T> concat(@NonNull Publisher<@NonNull ? extends MaybeSource<? extends T>> sources, @NonNull StandardBufferedConfig config) {
        Objects.requireNonNull(sources, "sources is null");
    ...
    @SafeVarargs
    @NonNull
    public static <@NonNull T> Flowable<T> concatArray(@NonNull StandardBufferedConfig config, @NonNull MaybeSource<? extends T>... sources) {
        Objects.requireNonNull(sources, "sources is null");
        Objects.requireNonNull(config, "config is null");
        if (sources.length == 0) {
            return Flowable.empty();
     ...
     * {@link io.reactivex.rxjava4.core base reactive classes}. Those operators signal a {@link NullPointerException} if the value returned by their
     ...
     *   {@link io.reactivex.rxjava4.plugins.RxJavaPlugins#onError(Throwable)} wrapped into a
     *   {@link io.reactivex.rxjava4.exceptions.UndeliverableException UndeliverableException}.
    ...
    public static <@NonNull T> Flowable<T> merge(@NonNull Publisher<@NonNull ? extends MaybeSource<? extends T>> sources) {
        return merge(sources, StandardConcurrentConfig.DEFAULT);
    }
    ...
    @NonNull
    @SchedulerSupport(SchedulerSupport.NONE)
    public static <@NonNull T> Flowable<T> merge(@NonNull Publisher<@NonNull ? extends MaybeSource<? extends T>> sources, @NonNull StandardConcurrentConfig config) {
        Objects.requireNonNull(sources, "sources is null");
        Objects.requireNonNull(config, "config is null");
