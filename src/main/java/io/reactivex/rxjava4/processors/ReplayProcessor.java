 ...
 *  <dt><b>Scheduler:</b></dt>
 *  <dd>{@code ReplayProcessor} does not operate by default on a particular {@link io.reactivex.rxjava4.core.Scheduler} and
...
public final class ReplayProcessor<@NonNull T> extends FlowableProcessor<T> {
     ...
     * even if the buffer evicts items due to the time constraint in the meantime. In other words, once a
     ...
     * buffer evicts items due to the time constraint in the meantime. In other words, once a {@code Subscriber}
