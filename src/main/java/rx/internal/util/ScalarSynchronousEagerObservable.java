...
public final class ScalarSynchronousEagerObservable<T> extends ScalarSynchronousObservable<T> {

    public static final <T> ScalarSynchronousEagerObservable<T> create(T value) {
        return new ScalarSynchronousEagerObservable<T>(value);
    }

    private final T value;

    protected ScalarSynchronousEagerObservable(final T t) {
