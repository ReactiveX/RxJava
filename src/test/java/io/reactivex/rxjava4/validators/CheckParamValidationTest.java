...
import io.reactivex.rxjava4.core.BackpressureOverflowStrategy;
import io.reactivex.rxjava4.core.BackpressureStrategy;
import io.reactivex.rxjava4.core.Completable;
import io.reactivex.rxjava4.core.CompletableConverter;
import io.reactivex.rxjava4.core.CompletableEmitter;
import io.reactivex.rxjava4.core.CompletableObserver;
import io.reactivex.rxjava4.core.CompletableOnSubscribe;
import io.reactivex.rxjava4.core.CompletableOperator;
import io.reactivex.rxjava4.core.CompletableSource;
import io.reactivex.rxjava4.core.CompletableTransformer;
import io.reactivex.rxjava4.core.CompletionStageDisposable;
import io.reactivex.rxjava4.core.Flowable;
import io.reactivex.rxjava4.core.FlowableConverter;
import io.reactivex.rxjava4.core.FlowableEmitter;
import io.reactivex.rxjava4.core.FlowableOnSubscribe;
import io.reactivex.rxjava4.core.FlowableOperator;
import io.reactivex.rxjava4.core.FlowableSubscriber;
import io.reactivex.rxjava4.core.FlowableTransformer;
import io.reactivex.rxjava4.core.Maybe;
import io.reactivex.rxjava4.core.MaybeConverter;
import io.reactivex.rxjava4.core.MaybeEmitter;
import io.reactivex.rxjava4.core.MaybeObserver;
import io.reactivex.rxjava4.core.MaybeOnSubscribe;
import io.reactivex.rxjava4.core.MaybeOperator;
import io.reactivex.rxjava4.core.MaybeSource;
import io.reactivex.rxjava4.core.MaybeTransformer;
import io.reactivex.rxjava4.core.Observable;
import io.reactivex.rxjava4.core.ObservableConverter;
import io.reactivex.rxjava4.core.ObservableEmitter;
import io.reactivex.rxjava4.core.ObservableOnSubscribe;
import io.reactivex.rxjava4.core.ObservableOperator;
import io.reactivex.rxjava4.core.ObservableSource;
import io.reactivex.rxjava4.core.ObservableTransformer;
import io.reactivex.rxjava4.core.Observer;
import io.reactivex.rxjava4.core.RxJavaTest;
import io.reactivex.rxjava4.core.Scheduler;
import io.reactivex.rxjava4.core.Single;
import io.reactivex.rxjava4.core.SingleConverter;
import io.reactivex.rxjava4.core.SingleEmitter;
import io.reactivex.rxjava4.core.SingleObserver;
import io.reactivex.rxjava4.core.SingleOnSubscribe;
import io.reactivex.rxjava4.core.SingleOperator;
import io.reactivex.rxjava4.core.SingleSource;
import io.reactivex.rxjava4.core.SingleTransformer;
import io.reactivex.rxjava4.core.StreamSink;
import io.reactivex.rxjava4.core.Streamable;
import io.reactivex.rxjava4.core.StreamableConverter;
import io.reactivex.rxjava4.core.StreamableOperator;
import io.reactivex.rxjava4.core.Streamer;
import io.reactivex.rxjava4.core.VirtualGenerator;
import io.reactivex.rxjava4.core.VirtualTransformer;
...
import io.reactivex.rxjava4.parallel.ParallelFailureHandling;
import io.reactivex.rxjava4.parallel.ParallelFlowable;
import io.reactivex.rxjava4.parallel.ParallelFlowableConverter;
import io.reactivex.rxjava4.parallel.ParallelTransformer;
...
public class CheckParamValidationTest extends RxJavaTest {
    ...
    static {
        ...
        addOverride(new ParamOverride(Streamable.class, 0, ParamMode.NON_NEGATIVE, "repeat", Long.TYPE));
        addOverride(new ParamOverride(Streamable.class, 0, ParamMode.NON_NEGATIVE, "retry", Long.TYPE));
        ...
        defaultValues.put(DisposableStreamerCancellation.class, new CompositeDisposable());
