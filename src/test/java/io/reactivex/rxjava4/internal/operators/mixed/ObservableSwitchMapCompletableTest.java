...
public class ObservableSwitchMapCompletableTest extends RxJavaTest {
    ...
    public void checkBadSource() {
        TestHelper.checkDoubleOnSubscribeObservableToCompletable((Function<Observable<Object>, Completable>) f ->
            f.switchMapCompletable(Functions.justFunction(Completable.never())));
    }

    @Test
    public void mapperCrash() {
        Observable.range(1, 5).switchMapCompletable(_ -> {
