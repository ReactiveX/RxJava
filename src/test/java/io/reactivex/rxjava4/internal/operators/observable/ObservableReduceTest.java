...
public class ObservableReduceTest extends RxJavaTest {
    ...
    public void reduceMaybeDoubleOnSubscribe() {
        TestHelper.checkDoubleOnSubscribeObservableToMaybe(o -> o.reduce((a, _) -> a));
    }

    @Test
    public void reduceMaybeCheckDisposed() {
        TestHelper.checkDisposed(Observable.just(new Object()).reduce((a, _) -> a));
    }
    ...
    public void seedDoubleOnSubscribe() {
        TestHelper.checkDoubleOnSubscribeObservableToSingle((Function<Observable<Integer>, SingleSource<Integer>>) o -> o.reduce(0, (a, _) -> a));
    }

    @Test
    public void seedDisposed() {
        TestHelper.checkDisposed(PublishSubject.<Integer>create().reduce(0, (a, _) -> a));
    }
