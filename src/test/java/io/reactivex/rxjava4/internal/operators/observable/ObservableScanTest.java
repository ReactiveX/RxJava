...
public class ObservableScanTest extends RxJavaTest {
    ...
    @Test
    public void dispose() {
        TestHelper.checkDisposed(PublishSubject.create().scan((a, _) -> a));
    ...
    public void doubleOnSubscribe() {
        TestHelper.checkDoubleOnSubscribeObservable(o -> o.scan((a, _) -> a));

        TestHelper.checkDoubleOnSubscribeObservable(o -> o.scan(0, (BiFunction<Object, Object, Object>) (a, _) -> a));
    }
    ...
    public void badSource() {
        TestHelper.checkBadSourceObservable((Function<Observable<Object>, Object>) o -> o.scan(0, (BiFunction<Object, Object, Object>) (a, _) -> a), false, 1, 1, 0, 0);
    }
