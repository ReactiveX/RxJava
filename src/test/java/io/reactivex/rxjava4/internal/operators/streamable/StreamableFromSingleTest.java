...
public class StreamableFromSingleTest extends StreamableBaseTest {

    @Test
    public void normal() throws Throwable {
        Streamable.fromSingle(Single.just(1))
        .test()
    ...
    @Test
    public void normalViaSingle() throws Throwable {
        Single.just(1)
        .toStreamable()
        .test()
        .awaitDone(5, TimeUnit.SECONDS)
