...
import io.reactivex.rxjava4.internal.operators.observable.ObservableReplay.*;
...
//        ts.assertUnsubscribed();
    ...
    public void replaySelectorReturnsNull() {
        Observable.just(1)
        .replay((Function<Observable<Integer>, Observable<Object>>) _ -> null)
    ...
    public void noBoundedRetentionViaThreadLocal() throws Exception {
        ...
        .concatMap((Function<byte[], Observable<byte[]>>) _ -> o), 1)
        .takeLast(1)
        ;
