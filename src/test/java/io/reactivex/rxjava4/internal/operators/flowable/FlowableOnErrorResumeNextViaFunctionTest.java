...
public class FlowableOnErrorResumeNextViaFunctionTest extends RxJavaTest {
    ...
    public void backpressure() {
        ...
        Flowable.range(0, 100000)
                .onErrorResumeNext((Function<Throwable, Flowable<Integer>>) _ -> Flowable.just(1))
    ...
    public void normalBackpressure() {
        ...
        pp.onErrorResumeNext((Function<Throwable, Flowable<Integer>>) _ -> Flowable.range(3, 2)).subscribe(ts);
