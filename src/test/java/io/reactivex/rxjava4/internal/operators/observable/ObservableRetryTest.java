...
public class ObservableRetryTest extends RxJavaTest {
    ...
    public void iterativeBackoff() {
        ...
        producer.retryWhen((Function<Observable<? extends Throwable>, Observable<Object>>) attempts -> {
    ...
    public void schedulingNotificationHandler() {
        ...
        origin.retryWhen((Function<Observable<? extends Throwable>, Observable<Object>>) t1 -> t1
        .observeOn(Schedulers.computation())
        .map((Function<Throwable, Object>) _ -> 1).startWithItem(1))
    ...
    public void onNextFromNotificationHandler() {
        ...
        int numRetries = 2;
        Observable<String> origin = Observable.unsafeCreate(new FuncWithErrors(numRetries));
        origin.retryWhen((Function<Observable<? extends Throwable>, Observable<Object>>) t1 ->
            t1.map((Function<Throwable, Integer>) _ -> 0).startWithItem(0).cast(Object.class)).subscribe(observer);
    ...
    public void onCompletedFromNotificationHandler() {
        ...
        TestObserver<String> to = new TestObserver<>(observer);
        origin.retryWhen((Function<Observable<? extends Throwable>, Observable<?>>) _ -> Observable.empty()).subscribe(to);
    ...
    public void onErrorFromNotificationHandler() {
        ...
        origin.retryWhen((Function<Observable<? extends Throwable>, Observable<?>>) _ -> Observable.error(new RuntimeException())).subscribe(observer);
    ...
    public void singleSubscriptionOnFirst() throws Exception {
        ...
        ObservableSource<Integer> onSubscribe = observer -> {
        ...
        int first = Observable.unsafeCreate(onSubscribe)
                .retryWhen((Function<Observable<? extends Throwable>, Observable<?>>) attempt ->
    ...
    public void unsubscribeFromRetry() {
        ...
        Disposable sub = subject.retry().subscribe(_ -> count.incrementAndGet());
        subject.onNext(1);
        sub.dispose();
        subject.onNext(2);
    ...
    public void retryAllowsSubscriptionAfterAllSubscriptionsUnsubscribed() throws InterruptedException {
        ...
        ObservableSource<String> onSubscribe = observer -> {
            subsCount.incrementAndGet();
            observer.onSubscribe(Disposable.fromRunnable(subsCount::decrementAndGet));
...
//                    s.unsubscribe();
    ...
    public void issue1900() throws InterruptedException {
        ...
        origin.retry()
        .groupBy(t1 -> t1)
        .flatMap((Function<GroupedObservable<String, String>, Observable<String>>) t1 -> t1.take(1))
    ...
    public void issue1900SourceNotSupportingBackpressure() {
        ...
        Observable<String> origin = Observable.unsafeCreate(o -> {
            o.onSubscribe(Disposable.empty());
    ...
    public void retryLongPredicateInvalid() {
        try {
            Observable.just(1).retry(-99, _ -> true);
    ...
    public void shouldDisposeInnerObservable() {
        ...
        final Disposable disposable = Observable.error(new RuntimeException("Leak"))
                .retryWhen((Function<Observable<Throwable>, ObservableSource<Object>>) errors ->
                    errors.switchMap((Function<Throwable, ObservableSource<Object>>) _ -> subject))
                .subscribe();
    ...
    public void noCancelPreviousRetry() {
        ...
        Observable<Integer> source = Observable.defer((Supplier<ObservableSource<Integer>>) () -> {
    ...
    public void noCancelPreviousRepeatWhen() {
        ...
        source.retryWhen(e -> e.takeWhile((Predicate<Object>) _ -> times.getAndIncrement() < 4))
        .test()
        .assertResult(1);
    ...
    public void noCancelPreviousRepeatWhen2() {
        ...
        Observable<Integer> source = Observable.<Integer>error(new TestException()).doOnDispose(counter::getAndIncrement);
    ...
    public void repeatFloodNoSubscriptionError() {
        ...
        try {
            ...
            for (int i = 0; i < TestHelper.RACE_DEFAULT_LOOPS; i++) {
                ...
                .retryWhen((Function<Observable<Throwable>, ObservableSource<Integer>>) _ -> signaller).test();
