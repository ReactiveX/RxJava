...
import io.reactivex.rxjava4.internal.operators.observable.ObservableMapNotification.MapNotificationObserver;
...
public class ObservableMapNotificationTest extends RxJavaTest {
    ...
    public void just() {
        ...
        Observable.just(1)
        .flatMap(
                (Function<Integer, Observable<Object>>) item -> Observable.just(item + 1),
    ...
    public void onErrorCrash() {
        ...
        .flatMap(Functions.justFunction(Observable.just(1)),
                (Function<Throwable, Observable<Integer>>) _ -> {
