...
public class ObservableGroupJoinTest extends RxJavaTest {
    ...
    public void leftDurationSelectorThrows() {
        ...
        Function<Integer, Observable<Integer>> fail = _ -> {
    ...
    public void resultSelectorThrows() {
        ...
        BiFunction<Integer, Observable<Integer>, Integer> fail = (_, _) -> {
            throw new RuntimeException("Forced failure");
        };
    ...
    public void dispose() {
        TestHelper.checkDisposed(Observable.just(1).groupJoin(
            Observable.just(2),
                _ -> Observable.never(),
                _ -> Observable.never(),
                (BiFunction<Integer, Observable<Integer>, Object>) (_, l) -> l
        ));
    }
    ...
    public void innerErrorLeft() {
        ...
        .groupJoin(
            Observable.just(2),
                _ -> Observable.error(new TestException()),
                _ -> Observable.never(),
                (_, l) -> l
        )
        .flatMap(Functions.<Observable<Integer>>identity())
