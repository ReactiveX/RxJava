...
public class ObservableWindowWithStartEndObservableTest extends RxJavaTest {
    ...
    public void observableBasedOpenerAndCloser() {
        ...
        Function<Object, Observable<Object>> closer = _ -> Observable.unsafeCreate(innerObserver -> {
            innerObserver.onSubscribe(Disposable.empty());
    ...
    public void noUnsubscribeAndNoLeak() {
        ...
        source.window(open, (Function<Integer, Observable<Integer>>) _ -> close)
        .doOnNext(w -> {
...
//        assertTrue("Not cancelled!", ts.isCancelled());
    ...
    public void boundarySelectorNormal() {
        ...
        TestObserver<Integer> to = source.window(start, _ -> end)
    ...
    public void badSourceCallable() {
        TestHelper.checkBadSourceObservable((Function<Observable<Object>, Object>) o ->
            o.window(Observable.just(1), Functions.justFunction(Observable.never())), false, 1, 1, (Object[])null);
    }
    ...
    public void mainAndBoundaryDisposeOnNoWindows() {
        ...
        .window(observableDisposed(openDisposed), _ -> observableDisposed(closeDisposed))
        .doOnNext(w -> {
            w.subscribe(Functions.emptyConsumer(), Functions.emptyConsumer()); // avoid abandonment
        })
    ...
    public void closingIndicatorFunctionCrash() {
        ...
        TestObserver<Observable<Integer>> to = source.window(boundary, (Function<Integer, Observable<Object>>) _ -> {
