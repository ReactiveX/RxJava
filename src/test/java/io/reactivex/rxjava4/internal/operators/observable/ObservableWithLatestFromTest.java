...
//        assertTrue("Not cancelled!", ts.isCancelled());
    ...
    @Test
    public void dispose() {
        TestHelper.checkDisposed(Observable.just(1).withLatestFrom(Observable.just(2), (BiFunction<Integer, Integer, Object>) (a, _) -> a));

        TestHelper.checkDisposed(Observable.just(1).withLatestFrom(Observable.just(2), Observable.just(3), (Function3<Integer, Integer, Integer, Object>) (a, _, _) -> a));
    }

    @Test
    public void manyIteratorThrows() {
        Observable.just(1)
        .withLatestFrom(new CrashingMappedIterable<>(1, 100, 100, _ -> Observable.just(2)), (Function<Object[], Object>) a -> a)
    ...
    public void manyCombinerThrows() {
        Observable.just(1).withLatestFrom(Observable.just(2), Observable.just(3), (_, _, _) -> {
    ...
    public void manyErrors() {
        ...
        try {
            ...
            }.withLatestFrom(Observable.just(2), Observable.just(3), (Function3<Integer, Integer, Integer, Object>) (a, _, _) -> a)
            .to(TestHelper.<Object>testConsumer())
    ...
    public void combineToNull1() {
        Observable.just(1)
        .withLatestFrom(Observable.just(2), (_, _) -> null)
        .test()
    ...
    public void combineToNull2() {
        Observable.just(1)
        .withLatestFrom(Arrays.asList(Observable.just(2), Observable.just(3)), _ -> null)
        .test()
        .assertFailure(NullPointerException.class);
    }
