...
public class ObservableRepeatTest extends RxJavaTest {
    ...
    public void shouldDisposeInnerObservable() {
        ...
        final Disposable disposable = Observable.just("Leak")
                .repeatWhen((Function<Observable<Object>, ObservableSource<Object>>) completions ->
                    completions.switchMap((Function<Object, ObservableSource<Object>>) _ -> subject))
                .subscribe();
    ...
    public void handlerError() {
        ...
        .repeatWhen((Function<Observable<Object>, ObservableSource<Object>>) v -> v.map(_ -> {
            throw new TestException();
        }))
        .test()
    ...
    public void noCancelPreviousRepeatWhen() {
        ...
        source.repeatWhen(e -> e.takeWhile(_ -> times.getAndIncrement() < 4))
        .test()
        .assertResult(1, 1, 1, 1, 1);
    ...
    public void repeatFloodNoSubscriptionError() {
        ...
        try {
            ...
            for (int i = 0; i < TestHelper.RACE_DEFAULT_LOOPS; i++) {
                ...
                .repeatWhen((Function<Observable<Object>, ObservableSource<Integer>>) _ -> signaller).test();
