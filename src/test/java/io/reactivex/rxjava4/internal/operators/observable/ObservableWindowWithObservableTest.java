...
public class ObservableWindowWithObservableTest extends RxJavaTest {
    ...
    public void innerBadSource() {
        TestHelper.checkBadSourceObservable(o -> Observable.just(1).window(o)
                .flatMap((Function<Observable<Integer>, ObservableSource<Integer>>) v -> v), false, 1, 1, (Object[])null);
    }
    ...
    public void badSource() {
        TestHelper.checkBadSourceObservable((Function<Observable<Object>, Object>) o ->
            o.window(Observable.never()).flatMap((Function<Observable<Object>, ObservableSource<Object>>) v -> v), false, 1, 1, 1);
    }

    @Test
    public void boundaryDirectDoubleOnSubscribe() {
        TestHelper.checkDoubleOnSubscribeObservable((Function<Observable<Object>, Observable<Observable<Object>>>) f ->
            f.window(Observable.never()).takeLast(1));
    }
