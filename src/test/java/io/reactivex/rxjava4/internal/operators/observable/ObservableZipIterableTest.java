...
public class ObservableZipIterableTest extends RxJavaTest {
    ...
    @Test
    public void dispose() {
        TestHelper.checkDisposed(Observable.just(1).zipWith(List.of(1), (BiFunction<Integer, Integer, Object>) Integer::sum));
    }

    @Test
    public void doubleOnSubscribe() {
        TestHelper.checkDoubleOnSubscribeObservable((Function<Observable<Integer>, ObservableSource<Object>>) o ->
            o.zipWith(List.of(1), (BiFunction<Integer, Integer, Object>) Integer::sum));
    }
