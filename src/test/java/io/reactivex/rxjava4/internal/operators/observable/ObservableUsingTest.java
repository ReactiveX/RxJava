...
public class ObservableUsingTest extends RxJavaTest {
    ...
    private void performTestUsingWithResourceFactoryError(boolean disposeEagerly) {
        ...
        Function<Disposable, Observable<Integer>> observableFactory = _ -> Observable.empty();
    ...
    private void performTestUsingWithObservableFactoryError(boolean disposeEagerly) {
        ...
        Function<Disposable, Observable<Integer>> observableFactory = _ -> {
            throw new TestException();
        };
    ...
    public void dispose() {
        TestHelper.checkDisposed(Observable.using(
                (Supplier<Object>) () -> 1,
                (Function<Object, ObservableSource<Object>>) _ -> Observable.never(),
    ...
    public void supplierDisposerCrash() {
        TestObserverEx<Object> to = Observable.using((Supplier<Object>) () -> 1, (Function<Object, ObservableSource<Object>>) _ -> {
    ...
    public void eagerOnErrorDisposerCrash() {
        TestObserverEx<Object> to = Observable.using(() -> 1,
                (Function<Object, ObservableSource<Object>>) _ -> Observable.error(new TestException("First")),
                _ -> { throw new TestException("Second"); }
        )
        .to(TestHelper.<Object>testConsumer())
        .assertFailure(CompositeException.class);
    ...
    public void eagerOnCompleteDisposerCrash() {
        Observable.using((Supplier<Object>) () -> 1, (Function<Object, ObservableSource<Object>>) _ -> Observable.empty(), _ -> {
            throw new TestException("Second");
        })
        .to(TestHelper.<Object>testConsumer())
    ...
    public void eagerDisposeResourceThenDisposeUpstream() {
        ...
        Observable.using(Functions.justSupplier(1),
                        (Function<Integer, Observable<Integer>>) _ -> Observable.range(1, 2)
