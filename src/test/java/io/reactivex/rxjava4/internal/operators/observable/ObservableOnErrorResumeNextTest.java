...
public class ObservableOnErrorResumeNextTest extends RxJavaTest {
    ...
    public void functionThrowsError() {
        Subscription s = mock(Subscription.class);
        TestObservable w = new TestObservable(s, "one");
        Function<Throwable, Observable<String>> resume = _ -> {
    ...
    public void mapResumeAsyncNext() {
        ...
        Observable<String> o = w.onErrorResumeNext((Function<Throwable, Observable<String>>) _ ->
            Observable.just("twoResume", "threeResume").subscribeOn(Schedulers.computation()));
