...
public class NbpOperatorSerializeTest {
    ...
    public void testSingleThreadedBasic() {
        ...
        NbpObservable<String> w = NbpObservable.create(onSubscribe);
    ...
    public static class OnNextThread implements Runnable {
        ...
        private final NbpObserver<String> NbpObserver;
        private final int numStringsToSend;

        OnNextThread(NbpObserver<String> NbpObserver, int numStringsToSend) {
    ...
    public static class CompletionThread implements Runnable {
        ...
        CompletionThread(NbpObserver<String> NbpObserver, TestConcurrencyobserverEvent event, Future<?>... waitOnThese) {
            this.NbpObserver = NbpObserver;
            this.event = event;
    ...
    private static class BusyObserver extends NbpObserver<String> {
