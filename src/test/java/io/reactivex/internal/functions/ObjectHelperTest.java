...
public class ObjectHelperTest {
    ...
    @Test
    public void verifyCountPositive() throws Exception{
        assertEquals(1L, ObjectHelper.verifyCountPositive(1L));
    }
    ...
    public void verifyCountPositiveFail() throws Exception{
        assertEquals(-1L, ObjectHelper.verifyCountPositive(-1L));
    }
