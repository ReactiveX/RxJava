...
public class ObjectHelperTest {
    ...
    @Test
    public void verifyIndexPositive() throws Exception{
        assertEquals(1L, ObjectHelper.verifyIndexPositive(1L));
    }
    ...
    public void verifyIndexPositiveFail() throws Exception{
        assertEquals(-1L, ObjectHelper.verifyIndexPositive(-1L));
    }
