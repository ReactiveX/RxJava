...
public class FlowableFromSupplierTest extends RxJavaTest {
    ...
    public void fusedFlatMapExecution() {
        ...
        Flowable.just(1).flatMap(v -> Flowable.fromSupplier((Supplier<Object>) () -> ++calls[0]))
        .test()
        .assertResult(1);
    ...
    public void fusedFlatMapExecutionHidden() {
        ...
        Flowable.just(1).hide().flatMap(v -> Flowable.fromSupplier((Supplier<Object>) () -> ++calls[0]))
        .test()
        .assertResult(1);
    ...
    public void fusedFlatMapNull() {
        Flowable.just(1).flatMap(v -> Flowable.fromSupplier(() -> null))
        .test()
    ...
    public void fusedFlatMapNullHidden() {
        Flowable.just(1).hide().flatMap(v -> Flowable.fromSupplier(() -> null))
        .test()
        .assertFailure(NullPointerException.class);
    }
    ...
    public void undeliverableUponCancellation() throws Exception {
        ...
        try {
            ...
            Flowable.fromSupplier((Supplier<Integer>) () -> {
                ts.cancel();
