...
public class MaybeFlatMapSingleElementTest extends RxJavaTest {
    ...
    @Test
    public void dispose() {
        TestHelper.checkDisposed(Maybe.just(1).flatMapSingle((Function<Integer, SingleSource<Integer>>) integer -> Single.just(2)));
    }

    @Test
    public void doubleOnSubscribe() {
        TestHelper.checkDoubleOnSubscribeMaybe((Function<Maybe<Integer>, Maybe<Integer>>) m -> m.flatMapSingle((Function<Integer, SingleSource<Integer>>) integer -> Single.just(2)));
    }
