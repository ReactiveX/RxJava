...
trait Observable[+T]
{
   ...
   * is used to create an Observable which produces objects. When this
   ...
   * Additionally the `closings` argument is used to create an Observable which produces objects. 
