 ...
 */
public final class ActivePlan8<T1, T2, T3, T4, T5, T6, T7, T8> extends ActivePlan0 {
    private final Action8<T1, T2, T3, T4, T5, T6, T7, T8> onNext;
    ...
    ActivePlan8(
            ...
            Action8<T1, T2, T3, T4, T5, T6, T7, T8> onNext,
            Action0 onCompleted) {
        this.onNext = onNext;
