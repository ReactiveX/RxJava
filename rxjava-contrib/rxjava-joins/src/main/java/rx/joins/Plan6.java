 ...
 */
public final class Plan6<T1, T2, T3, T4, T5, T6, R> extends Plan0<R> {
    protected final Pattern6<T1, T2, T3, T4, T5, T6> expression;
    protected final Func6<T1, T2, T3, T4, T5, T6, R> selector;

    public Plan6(Pattern6<T1, T2, T3, T4, T5, T6> expression, Func6<T1, T2, T3, T4, T5, T6, R> selector) {
    ...
    public ActivePlan0 activate(Map<Object, JoinObserver> externalSubscriptions,
        ...
        ActivePlan0 activePlan = new ActivePlan6<T1, T2, T3, T4, T5, T6>(
                ...
                new Action6<T1, T2, T3, T4, T5, T6>() {
                    @Override
                    public void call(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6) {
                        R result;
                        try {
                            result = selector.call(t1, t2, t3, t4, t5, t6);
                        } catch (Throwable t) {
                            observer.onError(t);
                            return;
                        }
