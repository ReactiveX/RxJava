...
- (IOSObjectArray *)toArrayWithNSObjectArray:(IOSObjectArray *)a {
  ...
  if (((IOSObjectArray *) nil_chk(a))->size_ < s) {
    a = (IOSObjectArray *) cast_check(JavaLangReflectArray_newInstanceWithIOSClass_withInt_([[a java_getClass] getComponentType], s), IOSClass_arrayType(NSObject_class_(), 1));
  }
  IOSObjectArray *h = head_;
  jint n = capacity_;
  jint j = 0;
