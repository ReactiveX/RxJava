...
J2OBJC_FIELD_SETTER(RxInternalOperatorsOperatorTakeLast_$1, val$weakParent_, RxDopplJ2objcWeakReference *)

__attribute__((unused)) static void RxInternalOperatorsOperatorTakeLast_$1_initWithRxDopplJ2objcWeakReference_(RxInternalOperatorsOperatorTakeLast_$1 *self, RxDopplJ2objcWeakReference *capture$0);

__attribute__((unused)) static RxInternalOperatorsOperatorTakeLast_$1 *new_RxInternalOperatorsOperatorTakeLast_$1_initWithRxDopplJ2objcWeakReference_(RxDopplJ2objcWeakReference *capture$0) NS_RETURNS_RETAINED;

__attribute__((unused)) static RxInternalOperatorsOperatorTakeLast_$1 *create_RxInternalOperatorsOperatorTakeLast_$1_initWithRxDopplJ2objcWeakReference_(RxDopplJ2objcWeakReference *capture$0);
...
- (RxSubscriber *)callWithId:(RxSubscriber *)subscriber {
  ...
  [subscriber setProducerWithRxProducer:create_RxInternalOperatorsOperatorTakeLast_$1_initWithRxDopplJ2objcWeakReference_(weakParent)];
  return parent;
}
...
- (instancetype)initWithRxDopplJ2objcWeakReference:(RxDopplJ2objcWeakReference *)capture$0 {
  RxInternalOperatorsOperatorTakeLast_$1_initWithRxDopplJ2objcWeakReference_(self, capture$0);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "request", "J", "LRxDopplJ2objcWeakReference;", "(Lrx/doppl/J2objcWeakReference<Lrx/internal/operators/OperatorTakeLast$TakeLastSubscriber<TT;>;>;)V", "Lrx/doppl/J2objcWeakReference<Lrx/internal/operators/OperatorTakeLast$TakeLastSubscriber<TT;>;>;", "LRxInternalOperatorsOperatorTakeLast;", "callWithId:" };
...
void RxInternalOperatorsOperatorTakeLast_$1_initWithRxDopplJ2objcWeakReference_(RxInternalOperatorsOperatorTakeLast_$1 *self, RxDopplJ2objcWeakReference *capture$0) {
  JreStrongAssign(&self->val$weakParent_, capture$0);
  NSObject_init(self);
}

RxInternalOperatorsOperatorTakeLast_$1 *new_RxInternalOperatorsOperatorTakeLast_$1_initWithRxDopplJ2objcWeakReference_(RxDopplJ2objcWeakReference *capture$0) {
  J2OBJC_NEW_IMPL(RxInternalOperatorsOperatorTakeLast_$1, initWithRxDopplJ2objcWeakReference_, capture$0)
}

RxInternalOperatorsOperatorTakeLast_$1 *create_RxInternalOperatorsOperatorTakeLast_$1_initWithRxDopplJ2objcWeakReference_(RxDopplJ2objcWeakReference *capture$0) {
  J2OBJC_CREATE_IMPL(RxInternalOperatorsOperatorTakeLast_$1, initWithRxDopplJ2objcWeakReference_, capture$0)
}
