...
#include "RxDopplMockMAction0$Moxy.h"
...
@implementation RxDopplMockMAction0_Moxy

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  RxDopplMockMAction0_Moxy_init(self);
  return self;
}
...
- (void)call {
  @try {
    if ($__handler_ == nil) {
      ...
      [$__handler_ invokeWithId:self withJavaLangReflectMethod:[[self java_getClass] getMethod:@"call" parameterTypes:[IOSObjectArray arrayWithObjects:(id[]){  } count:0 type:IOSClass_class_()]] withNSObjectArray:[IOSObjectArray arrayWithObjects:(id[]){  } count:0 type:NSObject_class_()]];
    }
  }
  @catch (NSException *__ttlive) {
    if ([__ttlive isKindOfClass:[JavaLangRuntimeException class]]) {
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[6].selector = @selector(super$call);
  ...
  static const void *ptrTable[] = { "setHandler", "LJavaLangReflectInvocationHandler;", "LJavaLangCloneNotSupportedException;", "hashCode", "equals", "LNSObject;", "super$equals", "toString" };
  static const J2ObjcClassInfo _RxDopplMockMAction0_Moxy = { "MAction0$Moxy", "rx.doppl.mock", ptrTable, methods, fields, 7, 0x1, 13, 1, -1, -1, -1, -1, -1 };
  return &_RxDopplMockMAction0_Moxy;
}

@end

void RxDopplMockMAction0_Moxy_init(RxDopplMockMAction0_Moxy *self) {
  RxDopplMockMAction0_init(self);
}

RxDopplMockMAction0_Moxy *new_RxDopplMockMAction0_Moxy_init() {
  J2OBJC_NEW_IMPL(RxDopplMockMAction0_Moxy, init)
}

RxDopplMockMAction0_Moxy *create_RxDopplMockMAction0_Moxy_init() {
  J2OBJC_CREATE_IMPL(RxDopplMockMAction0_Moxy, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(RxDopplMockMAction0_Moxy)
