...
#include "RxCompletableTestFunc1a$Moxy.h"
...
@implementation RxCompletableTestFunc1a_Moxy

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  RxCompletableTestFunc1a_Moxy_init(self);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[6].selector = @selector(super$callWithRxCompletable_OnSubscribe:);
  ...
  static const void *ptrTable[] = { "setHandler", "LJavaLangReflectInvocationHandler;", "LJavaLangCloneNotSupportedException;", "call", "LRxCompletable_OnSubscribe;", "super$call", "hashCode", "equals", "LNSObject;", "super$equals", "toString" };
  static const J2ObjcClassInfo _RxCompletableTestFunc1a_Moxy = { "CompletableTestFunc1a$Moxy", "rx", ptrTable, methods, fields, 7, 0x1, 13, 1, -1, -1, -1, -1, -1 };
  return &_RxCompletableTestFunc1a_Moxy;
}

@end

void RxCompletableTestFunc1a_Moxy_init(RxCompletableTestFunc1a_Moxy *self) {
  RxCompletableTestFunc1a_init(self);
}

RxCompletableTestFunc1a_Moxy *new_RxCompletableTestFunc1a_Moxy_init() {
  J2OBJC_NEW_IMPL(RxCompletableTestFunc1a_Moxy, init)
}

RxCompletableTestFunc1a_Moxy *create_RxCompletableTestFunc1a_Moxy_init() {
  J2OBJC_CREATE_IMPL(RxCompletableTestFunc1a_Moxy, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(RxCompletableTestFunc1a_Moxy)
