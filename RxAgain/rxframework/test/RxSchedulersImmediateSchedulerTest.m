...
- (void)testMergeWithImmediateScheduler1 {
  ...
  RxObservable *o = [((RxObservable *) nil_chk([((RxObservable *) nil_chk(RxObservable_mergeWithRxObservable_withRxObservable_(o1, o2))) subscribeOnWithRxScheduler:RxSchedulersSchedulers_immediate()])) mapWithRxFunctionsFunc1:create_RxSchedulersImmediateSchedulerTest_$1_initWithNSString_(currentThreadName)];
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[1].selector = @selector(testMergeWithImmediateScheduler1);
  methods[2].selector = @selector(init);
  #pragma clang diagnostic pop
  static const void *ptrTable[] = { (void *)&RxSchedulersImmediateSchedulerTest__Annotations$0 };
  static const J2ObjcClassInfo _RxSchedulersImmediateSchedulerTest = { "ImmediateSchedulerTest", "rx.schedulers", ptrTable, methods, NULL, 7, 0x1, 3, 0, -1, -1, -1, -1, -1 };
