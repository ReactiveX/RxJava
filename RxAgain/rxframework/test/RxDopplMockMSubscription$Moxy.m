...
#include "RxDopplMockMSubscription$Moxy.h"
...
@implementation RxDopplMockMSubscription_Moxy

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  RxDopplMockMSubscription_Moxy_init(self);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[6].selector = @selector(super$isUnsubscribed);
  methods[7].selector = @selector(unsubscribe);
  methods[8].selector = @selector(super$unsubscribe);
  ...
  static const J2ObjcClassInfo _RxDopplMockMSubscription_Moxy = { "MSubscription$Moxy", "rx.doppl.mock", ptrTable, methods, fields, 7, 0x1, 15, 1, -1, -1, -1, -1, -1 };
  return &_RxDopplMockMSubscription_Moxy;
}

@end

void RxDopplMockMSubscription_Moxy_init(RxDopplMockMSubscription_Moxy *self) {
  RxDopplMockMSubscription_init(self);
}

RxDopplMockMSubscription_Moxy *new_RxDopplMockMSubscription_Moxy_init() {
  J2OBJC_NEW_IMPL(RxDopplMockMSubscription_Moxy, init)
}

RxDopplMockMSubscription_Moxy *create_RxDopplMockMSubscription_Moxy_init() {
  J2OBJC_CREATE_IMPL(RxDopplMockMSubscription_Moxy, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(RxDopplMockMSubscription_Moxy)
