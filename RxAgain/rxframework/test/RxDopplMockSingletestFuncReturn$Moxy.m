...
#include "RxDopplMockSingletestFuncReturn$Moxy.h"
...
@implementation RxDopplMockSingletestFuncReturn_Moxy

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  RxDopplMockSingletestFuncReturn_Moxy_init(self);
  return self;
}
...
- (id<RxSubscription>)callWithId:(id<RxSubscription>)t {
  @try {
    if ($__handler_ == nil) {
      ...
      return (id<RxSubscription>) cast_check([$__handler_ invokeWithId:self withJavaLangReflectMethod:[[self java_getClass] getMethod:@"call" parameterTypes:[IOSObjectArray arrayWithObjects:(id[]){ RxSubscription_class_() } count:1 type:IOSClass_class_()]] withNSObjectArray:[IOSObjectArray arrayWithObjects:(id[]){ t } count:1 type:NSObject_class_()]], RxSubscription_class_());
    }
  }
  @catch (NSException *__ttlive) {
    if ([__ttlive isKindOfClass:[JavaLangRuntimeException class]]) {
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[6].selector = @selector(super$callWithRxSubscription:);
  ...
  static const void *ptrTable[] = { "setHandler", "LJavaLangReflectInvocationHandler;", "LJavaLangCloneNotSupportedException;", "call", "LRxSubscription;", "super$call", "hashCode", "equals", "LNSObject;", "super$equals", "toString" };
  static const J2ObjcClassInfo _RxDopplMockSingletestFuncReturn_Moxy = { "FuncReturn$Moxy", "rx.doppl.mock.singletest", ptrTable, methods, fields, 7, 0x1, 13, 1, -1, -1, -1, -1, -1 };
  return &_RxDopplMockSingletestFuncReturn_Moxy;
}

@end

void RxDopplMockSingletestFuncReturn_Moxy_init(RxDopplMockSingletestFuncReturn_Moxy *self) {
  RxDopplMockSingletestFuncReturn_init(self);
}

RxDopplMockSingletestFuncReturn_Moxy *new_RxDopplMockSingletestFuncReturn_Moxy_init() {
  J2OBJC_NEW_IMPL(RxDopplMockSingletestFuncReturn_Moxy, init)
}

RxDopplMockSingletestFuncReturn_Moxy *create_RxDopplMockSingletestFuncReturn_Moxy_init() {
  J2OBJC_CREATE_IMPL(RxDopplMockSingletestFuncReturn_Moxy, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(RxDopplMockSingletestFuncReturn_Moxy)
