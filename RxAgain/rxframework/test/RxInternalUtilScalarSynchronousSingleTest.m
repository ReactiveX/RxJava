...
- (void)dealloc {
  JreCheckFinalize(self, [RxInternalUtilScalarSynchronousSingleTest_$2 class]);
  [super dealloc];
}
...
- (void)dealloc {
  JreCheckFinalize(self, [RxInternalUtilScalarSynchronousSingleTest_$3 class]);
  [super dealloc];
}
...
- (void)dealloc {
  JreCheckFinalize(self, [RxInternalUtilScalarSynchronousSingleTest_$5 class]);
  [super dealloc];
}
