...
- (void)callWithId:(RxSubscriber *)passS;
...
__attribute__((unused)) static void RxBackpressureTests_$14_initWithJavaUtilConcurrentConcurrentLinkedQueue_withJavaUtilConcurrentAtomicAtomicInteger_(RxBackpressureTests_$14 *self, JavaUtilConcurrentConcurrentLinkedQueue *capture$0, JavaUtilConcurrentAtomicAtomicInteger *capture$1);

__attribute__((unused)) static RxBackpressureTests_$14 *new_RxBackpressureTests_$14_initWithJavaUtilConcurrentConcurrentLinkedQueue_withJavaUtilConcurrentAtomicAtomicInteger_(JavaUtilConcurrentConcurrentLinkedQueue *capture$0, JavaUtilConcurrentAtomicAtomicInteger *capture$1) NS_RETURNS_RETAINED;

__attribute__((unused)) static RxBackpressureTests_$14 *create_RxBackpressureTests_$14_initWithJavaUtilConcurrentConcurrentLinkedQueue_withJavaUtilConcurrentAtomicAtomicInteger_(JavaUtilConcurrentConcurrentLinkedQueue *capture$0, JavaUtilConcurrentAtomicAtomicInteger *capture$1);

@interface RxBackpressureTests_$14_$1 : NSObject < RxProducer > {
 @public
  RxBackpressureTests_$14 *this$0_;
  jint i_;
  JavaLangRefWeakReference *val$s_;
}

- (void)requestWithLong:(jlong)n;

- (instancetype)initWithRxBackpressureTests_$14:(RxBackpressureTests_$14 *)outer$
                   withJavaLangRefWeakReference:(JavaLangRefWeakReference *)capture$0;

@end

J2OBJC_EMPTY_STATIC_INIT(RxBackpressureTests_$14_$1)

J2OBJC_FIELD_SETTER(RxBackpressureTests_$14_$1, this$0_, RxBackpressureTests_$14 *)
J2OBJC_FIELD_SETTER(RxBackpressureTests_$14_$1, val$s_, JavaLangRefWeakReference *)

__attribute__((unused)) static void RxBackpressureTests_$14_$1_initWithRxBackpressureTests_$14_withJavaLangRefWeakReference_(RxBackpressureTests_$14_$1 *self, RxBackpressureTests_$14 *outer$, JavaLangRefWeakReference *capture$0);

__attribute__((unused)) static RxBackpressureTests_$14_$1 *new_RxBackpressureTests_$14_$1_initWithRxBackpressureTests_$14_withJavaLangRefWeakReference_(RxBackpressureTests_$14 *outer$, JavaLangRefWeakReference *capture$0) NS_RETURNS_RETAINED;

__attribute__((unused)) static RxBackpressureTests_$14_$1 *create_RxBackpressureTests_$14_$1_initWithRxBackpressureTests_$14_withJavaLangRefWeakReference_(RxBackpressureTests_$14 *outer$, JavaLangRefWeakReference *capture$0);
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _RxBackpressureTests = { "BackpressureTests", "rx", ptrTable, methods, fields, 7, 0x1, 25, 2, -1, -1, -1, -1, -1 };
...
RxObservable *RxBackpressureTests_incrementingIntegersWithJavaUtilConcurrentAtomicAtomicInteger_withJavaUtilConcurrentConcurrentLinkedQueue_(JavaUtilConcurrentAtomicAtomicInteger *counter, JavaUtilConcurrentConcurrentLinkedQueue *threadsSeen) {
  RxBackpressureTests_initialize();
  return RxObservable_createWithRxObservable_OnSubscribe_(create_RxBackpressureTests_$14_initWithJavaUtilConcurrentConcurrentLinkedQueue_withJavaUtilConcurrentAtomicAtomicInteger_(threadsSeen, counter));
}
...
IOSObjectArray *RxBackpressureTests__Annotations$17() {
  return [IOSObjectArray arrayWithObjects:(id[]){ create_OrgJunitTest(OrgJunitTest_None_class_(), 40000) } count:1 type:JavaLangAnnotationAnnotation_class_()];
}
...
- (void)callWithId:(RxSubscriber *)passS {
  JavaLangRefWeakReference *s = create_JavaLangRefWeakReference_initWithId_(passS);
  [((RxSubscriber *) nil_chk(passS)) setProducerWithRxProducer:create_RxBackpressureTests_$14_$1_initWithRxBackpressureTests_$14_withJavaLangRefWeakReference_(self, s)];
}

- (instancetype)initWithJavaUtilConcurrentConcurrentLinkedQueue:(JavaUtilConcurrentConcurrentLinkedQueue *)capture$0
                      withJavaUtilConcurrentAtomicAtomicInteger:(JavaUtilConcurrentAtomicAtomicInteger *)capture$1 {
  RxBackpressureTests_$14_initWithJavaUtilConcurrentConcurrentLinkedQueue_withJavaUtilConcurrentAtomicAtomicInteger_(self, capture$0, capture$1);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  #pragma clang diagnostic ignored "-Wobjc-multiple-method-names"
  methods[0].selector = @selector(callWithId:);
  methods[1].selector = @selector(initWithJavaUtilConcurrentConcurrentLinkedQueue:withJavaUtilConcurrentAtomicAtomicInteger:);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
  ...
  static const void *ptrTable[] = { "call", "LRxSubscriber;", "(Lrx/Subscriber<-Ljava/lang/Integer;>;)V", "LJavaUtilConcurrentConcurrentLinkedQueue;LJavaUtilConcurrentAtomicAtomicInteger;", "(Ljava/util/concurrent/ConcurrentLinkedQueue<Ljava/lang/Thread;>;Ljava/util/concurrent/atomic/AtomicInteger;)V", "Ljava/util/concurrent/ConcurrentLinkedQueue<Ljava/lang/Thread;>;", "LRxBackpressureTests;", "incrementingIntegersWithJavaUtilConcurrentAtomicAtomicInteger:withJavaUtilConcurrentConcurrentLinkedQueue:", "Ljava/lang/Object;Lrx/Observable$OnSubscribe<Ljava/lang/Integer;>;" };
...
void RxBackpressureTests_$14_initWithJavaUtilConcurrentConcurrentLinkedQueue_withJavaUtilConcurrentAtomicAtomicInteger_(RxBackpressureTests_$14 *self, JavaUtilConcurrentConcurrentLinkedQueue *capture$0, JavaUtilConcurrentAtomicAtomicInteger *capture$1) {
  JreStrongAssign(&self->val$threadsSeen_, capture$0);
...
RxBackpressureTests_$14 *new_RxBackpressureTests_$14_initWithJavaUtilConcurrentConcurrentLinkedQueue_withJavaUtilConcurrentAtomicAtomicInteger_(JavaUtilConcurrentConcurrentLinkedQueue *capture$0, JavaUtilConcurrentAtomicAtomicInteger *capture$1) {
  J2OBJC_NEW_IMPL(RxBackpressureTests_$14, initWithJavaUtilConcurrentConcurrentLinkedQueue_withJavaUtilConcurrentAtomicAtomicInteger_, capture$0, capture$1)
}

RxBackpressureTests_$14 *create_RxBackpressureTests_$14_initWithJavaUtilConcurrentConcurrentLinkedQueue_withJavaUtilConcurrentAtomicAtomicInteger_(JavaUtilConcurrentConcurrentLinkedQueue *capture$0, JavaUtilConcurrentAtomicAtomicInteger *capture$1) {
  J2OBJC_CREATE_IMPL(RxBackpressureTests_$14, initWithJavaUtilConcurrentConcurrentLinkedQueue_withJavaUtilConcurrentAtomicAtomicInteger_, capture$0, capture$1)
}

@implementation RxBackpressureTests_$14_$1

- (void)requestWithLong:(jlong)n {
  if (n == 0) {
    return;
  }
  if (this$0_->val$threadsSeen_ != nil) {
    [this$0_->val$threadsSeen_ offerWithId:JavaLangThread_currentThread()];
  }
  jlong _c = [((JavaUtilConcurrentAtomicAtomicLong *) nil_chk(this$0_->requested_)) getAndAddWithLong:n];
  if (_c == 0) {
    while (![((RxSubscriber *) nil_chk([((JavaLangRefWeakReference *) nil_chk(val$s_)) get])) isUnsubscribed]) {
      [((JavaUtilConcurrentAtomicAtomicInteger *) nil_chk(this$0_->val$counter_)) incrementAndGet];
      [((RxSubscriber *) nil_chk([val$s_ get])) onNextWithId:JavaLangInteger_valueOfWithInt_(i_++)];
      if ([this$0_->requested_ decrementAndGet] == 0) {
        return;
      }
    }
  }
...
- (instancetype)initWithRxBackpressureTests_$14:(RxBackpressureTests_$14 *)outer$
                   withJavaLangRefWeakReference:(JavaLangRefWeakReference *)capture$0 {
  RxBackpressureTests_$14_$1_initWithRxBackpressureTests_$14_withJavaLangRefWeakReference_(self, outer$, capture$0);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[1].selector = @selector(initWithRxBackpressureTests_$14:withJavaLangRefWeakReference:);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "this$0_", "LRxBackpressureTests_$14;", .constantValue.asLong = 0, 0x1012, -1, -1, -1, -1 },
    { "i_", "I", .constantValue.asLong = 0, 0x0, -1, -1, -1, -1 },
    { "val$s_", "LJavaLangRefWeakReference;", .constantValue.asLong = 0, 0x1012, -1, -1, 4, -1 },
  };
  static const void *ptrTable[] = { "request", "J", "LRxBackpressureTests_$14;LJavaLangRefWeakReference;", "(Lrx/BackpressureTests$14;Ljava/lang/ref/WeakReference<Lrx/Subscriber<-Ljava/lang/Integer;>;>;)V", "Ljava/lang/ref/WeakReference<Lrx/Subscriber<-Ljava/lang/Integer;>;>;", "LRxBackpressureTests_$14;", "callWithId:" };
  static const J2ObjcClassInfo _RxBackpressureTests_$14_$1 = { "", "rx", ptrTable, methods, fields, 7, 0x8008, 2, 3, 5, -1, 6, -1, -1 };
  return &_RxBackpressureTests_$14_$1;
}

@end

void RxBackpressureTests_$14_$1_initWithRxBackpressureTests_$14_withJavaLangRefWeakReference_(RxBackpressureTests_$14_$1 *self, RxBackpressureTests_$14 *outer$, JavaLangRefWeakReference *capture$0) {
...
RxBackpressureTests_$14_$1 *new_RxBackpressureTests_$14_$1_initWithRxBackpressureTests_$14_withJavaLangRefWeakReference_(RxBackpressureTests_$14 *outer$, JavaLangRefWeakReference *capture$0) {
  J2OBJC_NEW_IMPL(RxBackpressureTests_$14_$1, initWithRxBackpressureTests_$14_withJavaLangRefWeakReference_, outer$, capture$0)
}

RxBackpressureTests_$14_$1 *create_RxBackpressureTests_$14_$1_initWithRxBackpressureTests_$14_withJavaLangRefWeakReference_(RxBackpressureTests_$14 *outer$, JavaLangRefWeakReference *capture$0) {
  J2OBJC_CREATE_IMPL(RxBackpressureTests_$14_$1, initWithRxBackpressureTests_$14_withJavaLangRefWeakReference_, outer$, capture$0)
}
